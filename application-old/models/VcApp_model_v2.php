<?php
class VcApp_model extends CI_Model {
...
if ($user->level==2){
$ptype=$user->ptype;
$statusCondition="pd_approve_status(vph.fmonth,\'".$ptype."\') = 'Approved'";
}else {
...
function visit_checklists($vpvid=NULL,$userid=NULL){
$this->db->select("vpvc.*,
vpv.*,
facilityname(vpv.facode) as facility,
facilitytype(vpv.facode) as fatype,
substr(vpv.facode,1,3) as distcode,
districtname(substr(vpv.facode,1,3)) as district,
