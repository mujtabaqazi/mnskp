					...
					<div class="rowlightbg">
						...
						<div class="row">
							...
							<div class="col-xs-3 zp">
								...
								<?php }else { ?>
								<input class="form-control <?php echo ($i==3||$i==6)?"numberclass noDots":"" ; ?>" value="<?php $var ='pclr_r'.$index.'_f1'; echo ($i==3 && isset($vpvcDataRow))?  get_Facility_Population($vpvcDataRow->facode):''; ?>" name="<?php echo $var; ?>" type="text">
								<?php } ?>
							</div>
							<?php if ($i!=17) { ?>
							<div class="col-xs-3">
							...
							<div class="col-xs-3 zp">
								...
								<?php }else {?>
								<input class="form-control <?php echo ($i==2||$i==6)?"numberclass noDots":"" ; ?>" value="<?php $var ='pclr_r'.$index.'_f2'; echo ($i==2 && isset($vpvcDataRow))?get_District_Population($vpvcDataRow->distcode):""; ?>" name="<?php echo $var; ?>" type="text">
								<?php } ?>
							</div>
							<?php } ?>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-3 zp">
								<input class="dp form-control anyOtherDate" value="<?php $var ='ss_r'.$i.'_f2'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" type="text">
							</div>
							<div class="col-xs-3 zp">
