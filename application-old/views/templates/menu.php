...
<?php
//LHW Program
if ((($ulevel=='2') || ($ulevel=='3')) && (($utype=='Manager') || ($utype=='Executive') || ($utype=='ProExecutive') || ($utype=='DEO')) && (($ptype=='all') || ($ptype=='lhw'))) {?>
<!--LHW-->
<li class="dropdown-submenu">
...
//MNCH Program
if ((($ulevel=='2') || ($ulevel=='3')) && (($utype=='Manager') || ($utype=='Executive') || ($utype=='ProExecutive') || ($utype=='DEO')) && (($ptype=='all') || ($ptype=='mnch'))) {?>
<li class="dropdown-submenu">
...
if ((($ulevel=='2') || ($ulevel=='3')) && (($utype=='Manager') || ($utype=='Executive') || ($utype=='ProExecutive') || ($utype=='DEO')) && (($ptype=='all') || ($ptype=='nutrition'))) {?>
<li class="dropdown-submenu">
