				...
				<div class="panel-body pbody">
					...
					<div class="row">
					  ...
					  <div class="col-xs-1 zp">
					  	<input value="<?php $var ="supply_avg_time";
							if(isset($DataRow)){
								if(strstr($DataRow->$var,"week(s)"))
								{
									$splitted = explode('week(s)', $DataRow->$var);
									$weeks = str_replace("week(s)","",$splitted[0]);
									$months = "";
									if(count($splitted)>1)
										$months = str_replace("month(s)","",$splitted[1]);
								}else
								{
									$weeks = "";
									$months = str_replace("month(s)","",$DataRow->$var);
								}
								
							} 
							echo trim($weeks); ?>" name="<?php echo $var; ?>[]" class="form-control numberclass" placeholder="Weeks">
					  </div>
					  <div class="col-xs-1 zp">
					  	<input value="<?php echo trim($months); ?>" name="<?php echo $var; ?>[]" class="form-control numberclass noDots" placeholder="Months">
					  </div>
					</div>
					<!-- <div class="row">
					...
					<div class="row">
					  ...
					  <div class="col-xs-2 zp">
						<input value="<?php $var ="store_date"; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
					  </div>
					  <div class="col-xs-2">
						<label class="mt5">Time:</label>
					  </div>
					  <div class="col-xs-2 zp">
						<input value="<?php $var ="store_time"; echo isset($DataRow)?date("H:i",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="single-input form-control" type="text">
					  </div>
					</div>
					<div class="row">
					  <div class="col-xs-2 col-xs-offset-3">
						...
						<div class="col-xs-2 zp">
							<select <?php $var = "store_location"; ?> name="<?php echo $var; ?>" class="form-control text-center">
								<option <?php echo isset($DataRow)?(($DataRow->$var=="Health House/FLCF")?'selected="selected"':''):''; ?> value="Health House/FLCF">Health House/FLCF</option>
								<option <?php echo isset($DataRow)?(($DataRow->$var=="District")?'selected="selected"':''):''; ?> value="District">District</option>
								<option <?php echo isset($DataRow)?(($DataRow->$var=="PPIU Warehouse")?'selected="selected"':''):''; ?> value="PPIU Warehouse">PPIU Warehouse</option>
								<option <?php echo isset($DataRow)?(($DataRow->$var=="Central Warehouse")?'selected="selected"':''):''; ?> value="Central Warehouse">Central Warehouse</option>
							</select>
						</div>
					...
					<div class="row rowmsr-filters row-signatures form-group">
					  ...
					  <div class="col-md-2">
						<input value="<?php $var ="dov"; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" id="<?php echo $var; ?>" class="dp1 form-control" placeholder="" type="text">
					  </div>
					</div>
					<div class="row">
							<div class="col-xs-6">
