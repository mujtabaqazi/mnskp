  ...
  <div class="container">
   ...
   <div class="panel-heading text-center"> Monitoring and Supervision
    ...
    <div class="row">
          ...
          <div class="col-xs-3" >
          <input class="form-control numberclass noDots" id="numb_cv_involved"  name="numb_cv_involved" value="<?php echo (isset($DataRow))?$DataRow->numb_cv_involved:''; ?>" type="text">
          </div>
        </div>
      <div class="row">
          ...
          <div class="col-xs-3">
            <div class="row">
              <div class="col-xs-6 text-right">
				...
				<input <?php $var ="lvs_r".$key."_f1";?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
                <input <?php $var="lvs_r".$key."_f1"; ?> name="<?php echo $var; ?>" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox">
              </div>
              <div class="col-xs-6">
                <label>Last month</label>&nbsp;
				<input <?php $var ="lvs_r".$key."_f2";?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
                <input <?php $var="lvs_r".$key."_f2"; ?> name="<?php echo $var; ?>" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox">
              </div>
            </div>
          </div>
          <div class="col-xs-3">
        ...
        <div class="row">
          ...
          <div class="col-xs-3">
            <div class="row">
              <div class="col-xs-6 text-right">
                <label>Yes</label>&nbsp;
                <input name="lvs_r9_f1" value="1" <?php echo (isset($DataRow) && $DataRow->lvs_r9_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="lvs_r9_f1" value="0" <?php echo (isset($DataRow) && $DataRow->lvs_r9_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input value="<?php echo (isset($DataRow))?$DataRow->lvs_r9_f2:''; ?>" name="lvs_r9_f2" class="form-control" type="text">
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-xs-3">
            <div class="row">
              <div class="col-xs-6 text-right">
                <label>Currently</label>&nbsp;
                <input name="lvs_r10_f1" value="1" <?php echo (isset($DataRow) && $DataRow->lvs_r10_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox">
              </div>
              <div class="col-xs-6">
                <label>Last month</label>&nbsp;
                <input name="lvs_r10_f2" value="1" <?php echo (isset($DataRow) && $DataRow->lvs_r10_f2 == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox">
              </div>
            </div>
          </div>
          <div class="col-xs-3">
            <div class="row">
              <div class="col-xs-6 text-right">
                <label>Yes</label>&nbsp;
                <input name="lvs_r10_f3" value="1" <?php echo (isset($DataRow) && $DataRow->lvs_r10_f3 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="lvs_r10_f3" value="0" <?php echo (isset($DataRow) && $DataRow->lvs_r10_f3 == '0')?'checked="checked"':''; ?>  class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input value="<?php echo (isset($DataRow))?$DataRow->lvs_r10_f4:''; ?>" name="lvs_r10_f4" class="form-control" type="text">
          </div>
        </div>
        <?php $labelArray=array(
        ...
        <div class="row">
		  ...
		  <input <?php $var ="vsc_r".$key."_f1";?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
		  <input <?php $var="vsc_r".$key."_f1"; ?> name="<?php echo $var; ?>" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox"></div>
          <div class="col-xs-2 text-center">
		  <input <?php $var ="vsc_r".$key."_f2";?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
		  <input <?php $var="vsc_r".$key."_f2"; ?> name="<?php echo $var; ?>" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox"></div>
          <div class="col-xs-2 text-center">
			<input <?php $var ="vsc_r".$key."_f3";?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
		  <input <?php $var="vsc_r".$key."_f3"; ?> name="<?php echo $var; ?>" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox"></div>
          <div class="col-xs-2 text-center">
			<input <?php $var ="vsc_r".$key."_f4";?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
		  <input <?php $var="vsc_r".$key."_f4"; ?> name="<?php echo $var; ?>" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="checkbox"></div>
        </div>
        <?php } ?>
        <div class="row bc mt1 mb1">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="ccs_r1_f1" value="1" <?php echo (isset($DataRow) && $DataRow->ccs_r1_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="ccs_r1_f1" value="0" <?php echo (isset($DataRow) && $DataRow->ccs_r1_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="ccs_r1_f2" name="ccs_r1_f2" value="<?php echo (isset($DataRow))?$DataRow->ccs_r1_f2:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-6 zp">
            <div class="row">
              <div class="col-xs-4 text-right zp">
                ...
                <input name="ccs_r2_f1" value="1" <?php echo (isset($DataRow) && $DataRow->ccs_r2_f1 == '1')?'checked="checked"':''; ?>  class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <label>Cold Box</label>&nbsp;
                <input name="ccs_r2_f1" value="2" <?php echo (isset($DataRow) && $DataRow->ccs_r2_f1 == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-left">
                <label>Ice-lined Freezer</label>&nbsp;
                <input name="ccs_r2_f1" value="3" <?php echo (isset($DataRow) && $DataRow->ccs_r2_f1 == '3')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
         </div>
         <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-4 text-right zp">
                <label>None</label>&nbsp;
                <input name="ccs_r3_f1" value="1" <?php echo (isset($DataRow) && $DataRow->ccs_r3_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <label>Some</label>&nbsp;
                <input name="ccs_r3_f1" value="2" <?php echo (isset($DataRow) && $DataRow->ccs_r3_f1 == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-left">
                <label>All</label>&nbsp;
                <input name="ccs_r3_f1" value="3" <?php echo (isset($DataRow) && $DataRow->ccs_r3_f1 == '3')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="ccs_r3_f2" name="ccs_r3_f2" value="<?php echo (isset($DataRow))?$DataRow->ccs_r3_f2:''; ?>" placeholder="If “none” or “some”, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
         ...
         <div class="row">
          ...
          <div class="col-xs-4 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Inside</label>&nbsp;
                <input name="ccs_r5_f1" value="1" <?php echo (isset($DataRow) && $DataRow->ccs_r5_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>Outside</label>&nbsp;
                <input name="ccs_r5_f1" value="2" <?php echo (isset($DataRow) && $DataRow->ccs_r5_f1 == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-4 zp">
            <div class="row">
              <div class="col-xs-4 text-right zp">
                <label>None</label>&nbsp;
                <input <?php $var="ccs_r".$key."_f1"; ?> name="<?php echo $var; ?>"  value="1" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <label>Some</label>&nbsp;
                <input <?php $var="ccs_r".$key."_f1"; ?> name="<?php echo $var; ?>" value="2" <?php echo (isset($DataRow) && $DataRow->$var == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-left">
                <label>All</label>&nbsp;
                <input <?php $var="ccs_r".$key."_f1"; ?> name="<?php echo $var; ?>" value="3" <?php echo (isset($DataRow) && $DataRow->$var == '3')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
         </div>
         ...
         <div class="row">
          ...
          <div class="col-xs-4 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes (please verify)</label>&nbsp;
                <input name="ccs_r11_f1" value="1" <?php echo (isset($DataRow) && $DataRow->ccs_r11_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="ccs_r11_f1" value="0" <?php echo (isset($DataRow) && $DataRow->ccs_r11_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
         </div>
         <div class="row">
          ...
          <div class="col-xs-4 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes (please verify)</label>&nbsp;
                <input name="ccs_r12_f1" value="1" <?php echo (isset($DataRow) && $DataRow->ccs_r12_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="ccs_r12_f1" value="0" <?php echo (isset($DataRow) && $DataRow->ccs_r12_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
         </div>
         <div class="row">
          ...
          <div class="col-xs-4 zp">
            <div class="row">
              <div class="col-xs-4 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="ccs_r13_f1" value="1" <?php echo (isset($DataRow) && $DataRow->ccs_r13_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <label>No</label>&nbsp;
                <input name="ccs_r13_f1" value="0" <?php echo (isset($DataRow) && $DataRow->ccs_r13_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
         </div>
         <div class="row">
          ...
          <div class="col-xs-4 zp">
            <input class="form-control" id="ccs_r13_f2" name="ccs_r13_f2" value="<?php echo (isset($DataRow))?$DataRow->ccs_r13_f2:''; ?>"  type="text">
          </div>
         </div>
         <div class="row bc mt1 mb1">
          <div class="col-xs-1">
		...
		<div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes(please verify)</label>&nbsp;
                <input <?php $var="ic_r".$key."_f1"; ?> name="<?php echo $var; ?>" value="1" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input <?php $var="ic_r".$key."_f1"; ?> name="<?php echo $var; ?>" value="0" <?php echo (isset($DataRow) && $DataRow->$var == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" <?php $var="ic_r".$key."_f2"; ?> name="<?php echo $var; ?>" id="<?php echo $var; ?>" value="<?php echo (isset($DataRow))?$DataRow->$var:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
		<?php }else{ ?>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes (please verify)</label>&nbsp;
                <input name="pa_r1_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r1_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r1_f1" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r1_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
               
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="pa_r1_f2" name="pa_r1_f2" value="<?php echo (isset($DataRow))?$DataRow->pa_r1_f2:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-4 text-right zp">
                <label>None</label>&nbsp;
                <input name="pa_r2_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r2_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <label>Some</label>&nbsp;
                <input name="pa_r2_f1" value="2" <?php echo (isset($DataRow) && $DataRow->pa_r2_f1 == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-left">
                <label>All</label>&nbsp;
                <input name="pa_r2_f1" value="3" <?php echo (isset($DataRow) && $DataRow->pa_r2_f1 == '3')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="pa_r2_f2" name="pa_r2_f2" value="<?php echo (isset($DataRow))?$DataRow->pa_r2_f2:''; ?>" placeholder="If “none” or “some”, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes (please verify)</label>&nbsp;
                <input name="pa_r3_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r3_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r3_f1" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r3_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="pa_r4_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r4_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r4_f1" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r4_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
               
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="pa_r4_f2" name="pa_r4_f2" value="<?php echo (isset($DataRow))?$DataRow->pa_r4_f2:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="pa_r5_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r5_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r5_f1" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r5_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
               
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="pa_r5_f2" name="pa_r5_f2" value="<?php echo (isset($DataRow))?$DataRow->pa_r5_f2:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes (please verify)</label>&nbsp;
                <input name="pa_r6_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r6_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r6_f1" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r6_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
               
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="pa_r6_f2" name="pa_r6_f2" value="<?php echo (isset($DataRow))?$DataRow->pa_r6_f2:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes (please verify)</label>&nbsp;
                <input name="pa_r6_f3" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r6_f3 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r6_f3" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r6_f3 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="pa_r7_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r7_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r7_f1" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r7_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="pa_r8_f1" value="1" <?php echo (isset($DataRow) && $DataRow->pa_r8_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="pa_r8_f1" value="0" <?php echo (isset($DataRow) && $DataRow->pa_r8_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="mva_r1_f1" value="1" <?php echo (isset($DataRow) && $DataRow->mva_r1_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="mva_r1_f1" value="0" <?php echo (isset($DataRow) && $DataRow->mva_r1_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <input value="<?php $var ='mva_r2_f1'; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
            <!-- <input class="form-control dp" id="mva_r2_f1" name="mva_r2_f1" value="<?php echo (isset($DataRow))?date('d-m-Y',strtotime($DataRow->mva_r2_f1)):''; ?>"  type="text"> -->
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="mva_r3_f1" name="mva_r3_f1" value="<?php echo (isset($DataRow))?$DataRow->mva_r3_f1:''; ?>"  type="text">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="mva_r4_f1" value="1" <?php echo (isset($DataRow) && $DataRow->mva_r4_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="mva_r4_f1" value="0" <?php echo (isset($DataRow) && $DataRow->mva_r4_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-4 text-right zp">
                ...
                <input name="mva_r5_f1" value="1" <?php echo (isset($DataRow) && $DataRow->mva_r5_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <label>LHV</label>&nbsp;
                <input name="mva_r5_f1" value="2" <?php echo (isset($DataRow) && $DataRow->mva_r5_f1 == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-left">
                <label>Other</label>&nbsp;
                <input name="mva_r5_f1" value="3" <?php echo (isset($DataRow) && $DataRow->ccs_r1_f1 == '3')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="mva_r5_f2" name="mva_r5_f2" value="<?php echo (isset($DataRow))?$DataRow->mva_r5_f2:''; ?>" placeholder="(Specify)" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="mva_r6_f1" value="1" <?php echo (isset($DataRow) && $DataRow->mva_r6_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="mva_r6_f1" value="0" <?php echo (isset($DataRow) && $DataRow->mva_r6_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
               
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="mva_r6_f2" name="mva_r6_f2" value="<?php echo (isset($DataRow))?$DataRow->mva_r6_f2:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes</label>&nbsp;
                <input name="mva_r7_f1" value="1" <?php echo (isset($DataRow) && $DataRow->mva_r7_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-6 text-center">
                <label>No</label>&nbsp;
                <input name="mva_r7_f1" value="0" <?php echo (isset($DataRow) && $DataRow->mva_r7_f1 == '0')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
               
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="mva_r7_f2" name="mva_r7_f2" value="<?php echo (isset($DataRow))?$DataRow->mva_r7_f2:''; ?>" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-4 zp">
            <div class="row">
              <div class="col-xs-2 text-right zp">
                <label>Foot</label>&nbsp;
                <input name="mva_r8_f1" value="1" <?php echo (isset($DataRow) && $DataRow->mva_r8_f1 == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-5 text-center">
                <label>EPI Motorcycle</label>&nbsp;
                <input name="mva_r8_f1" value="2" <?php echo (isset($DataRow) && $DataRow->mva_r8_f1 == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-5 text-left">
                <label>Other transport</label>&nbsp;
                <input name="mva_r8_f1" value="3" <?php echo (isset($DataRow) && $DataRow->mva_r8_f1 == '3')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="mva_r8_f2" name="mva_r8_f2" value="<?php echo (isset($DataRow))?$DataRow->mva_r8_f2:''; ?>" placeholder="(Specify)" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-11 col-xs-offset-1">
        ...
        <div class="row">
          ...
          <div class="col-xs-3">
            <div class="row">
              <div class="col-xs-4 text-center">
                <input <?php $var="mva_r".$key."_f1"; ?> name="<?php echo $var; ?>" value="1" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <input <?php $var="mva_r".$key."_f1"; ?> name="<?php echo $var; ?>" value="2" <?php echo (isset($DataRow) && $DataRow->$var == '2')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
              <div class="col-xs-4 text-center">
                <input <?php $var="mva_r".$key."_f1"; ?> name="<?php echo $var; ?>" value="3" <?php echo (isset($DataRow) && $DataRow->$var == '3')?'checked="checked"':''; ?> class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-2 zp">
             <input class="form-control" <?php $var="mva_r".$key."_f2"; ?> name="<?php echo $var; ?>" id="<?php echo $var; ?>" value="<?php echo (isset($DataRow))?$DataRow->$var:''; ?>"  type="text">
          </div>
        </div>
        <?php } ?>
          ...
          <?php for($i=1;$i<11;$i++){?>
			<div class="row">
				...
				<div class="col-xs-1 text-center cmargin27">
					<input <?php $var ='hhvt_r'.$i.'_f5';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
				...
				<div class="col-xs-1 text-center cmargin27">
					<input <?php $var ='hhvt_r'.$i.'_f6';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
				...
				<div class="col-xs-2">
					<div class="row">
						<div class="col-xs-4 text-center cmargin27">
							<input <?php $var ='hhvt_r'.$i.'_f7';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
						...
						<div class="col-xs-4 text-center cmargin27">
							<input <?php $var ='hhvt_r'.$i.'_f8';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
						...
						<div class="col-xs-4 text-center cmargin27">
							<input <?php $var ='hhvt_r'.$i.'_f9';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
				...
				<div class="col-xs-1">
					<div class="row">
					  <div class="col-xs-6 text-center cmargin27">
						<input <?php $var ='hhvt_r'.$i.'_f10';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
					  ...
					  <div class="col-xs-6 text-center cmargin27">
						<input <?php $var ='hhvt_r'.$i.'_f11';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
				...
				<div class="col-xs-1 text-center cmargin27">
					<input <?php $var = "hhvt_r".$i."_f12";?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
