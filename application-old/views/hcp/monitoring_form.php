    ...
    <?php $this->load->view("templates/chklsts_scripts"); ?>
      ...
      <form class="form-horizontal">
        ...
        <div class="row">
          ...
          <div class="col-xs-3">
            <input value="<?php $var ='date_sentinel'; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
          </div>
          <div class="col-xs-3 pt7">
        ...
        <div class="row">
          ...
          <div class="col-xs-2  ">
            <label>Irregular</label>&nbsp;<input <?php $var ='regular'; echo isset($DataRow)?(($DataRow->$var=="0")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="1" class="mt10" type="radio">
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-xs-2">
            <input value="<?php $var ='stk_register_no'; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-xs-2 col-xs-offset-1">
            <label>ICT&nbsp;&nbsp;</label>
            <input <?php $var="lab_services_ict"; ?> name="<?php echo $var; ?>" value="1" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> type="checkbox">
          </div>
          <div class="col-xs-2">
            <label>Elisa&nbsp;&nbsp;</label>
            <input <?php $var="lab_services_elisa"; ?> name="<?php echo $var; ?>" value="1" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> type="checkbox">
          </div>
          <div class="col-xs-2">
            <label>PCR&nbsp;&nbsp;</label>
            <input <?php $var="lab_services_ict_pcr"; ?> name="<?php echo $var; ?>" value="1" <?php echo (isset($DataRow) && $DataRow->$var == '1')?'checked="checked"':''; ?> type="checkbox">
          </div>
        </div>
        <div class="row" style="padding-bottom: 1px;">
           <div class="col-xs-10 col-xs-offset-1 cmargin27 bgcolcl">
        ...
        <div class="row">
          ...
          <div class="col-xs-1 zp">
            <input value="<?php $var ='stkp_r'.$i.'_f8'; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
        ...
        <div class="row">
          ...
          <div class="col-xs-4 zp">
            <input class="form-control" id="" value="<?php $var ="no_reason"; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" type="text">
          </div>
        </div>
        <div class="row" style="padding-bottom: 1px;">
           <div class="col-xs-10 col-xs-offset-1 cmargin27 bgcolcl">
        ...
        <div class="row">
          ...
          <div class="col-xs-2 zp">
            <input value="<?php $var ='invent_stk_r'.$i.'_f4'; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
        ...
        <div class="row">
          <div class="col-xs-12">
            <textarea id="" value="<?php $var ="comments"; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" rows="5" class="form-control" placeholder=""></textarea>
          </div>
        </div>
        <div class="row">
