...
<html>
	<head>
		...
		<title>LHW Services Checklist || List</title>
	...
	<body>
		...
		<div class="container container-listing">
			...
			<br>
			<?php echo getListingTable($tableData,"imc/forms/lhw"); ?>
			<?php if($paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>imc/ajax_calls/lhw",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>imc/ajax_calls/lhw/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
