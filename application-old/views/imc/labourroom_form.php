		...
		<div class="container">
			<div class="panel panel-primary">
				...
				<div class="panel-body pbody">
					...
					$action = $basePath."imc/labourroom/save";
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
							...
							<div class="col-xs-1 zp text-right">
								...
								<input <?php $var ='labrm_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="1" class="mt9" type="radio">
							</div>
							<div class="col-xs-1 zp text-right">
								<label><?php echo ($i<3)?"Average":"No"; ?></label>&nbsp;
								<input <?php $var ='labrm_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="0" class="mt9" type="radio">
							</div>
							<div class="col-xs-1 zp text-center">
							<?php if($i<3){ ?>
								<label>Poor</label>&nbsp;
								<input <?php $var ='labrm_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="2")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="2" class="mt9" type="radio">
							<?php } ?>
							</div>
						</div>
						<?php 	} ?>
