...
<html>
	<head>
		...
		<title>Monitoring Checklist for Nutrition Stabilization Centers</title>
							...
							<div class="rowlightbg">
							  ...
							  <?php
								...
								for ($index=1;$index<=count($lables);$index++){ ?>
								  <div class="row">
									...
									<div class="col-xs-1 text-center">
									   <p><?php $var ='fp_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':''):''; ?></p>
									</div>
									<div class="col-xs-1 text-center">
									   <p><?php $var ='fp_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'No':''):''; ?></p>
									</div>
									<div class="col-xs-2  ">
								...
								for($index=1;$index<=count($lables);$index++){
									if($index==6||$index==12||$index==18||$index==22||$index==25||$index==29){ ?>
				      				 <div class="row mt1">
							        <div class="col-sm-8 bc ">
							          <label><label><?php echo $lables[$index-1];?></label></label>
							        </div>
							      </div>
								<?php
								}else{ ?>
									<div class="row">
										...
										<div class="col-xs-1 text-center">
										   <p><?php $var ='hnsc_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':''):''; ?></p>
										</div>
										<div class="col-xs-1 text-center">
										   <p><?php $var ='hnsc_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'No':''):''; ?></p>
										</div>
										<div class="col-xs-2  ">
							  ...
							  <?php
								...
								<div class="row">
							        ...
							        <div class="col-xs-1 text-center">
							           <p><?php $var ='wp_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':''):''; ?></p>
							        </div>
							        <div class="col-xs-1 text-center">
							           <p><?php $var ='wp_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'No':''):''; ?></p>
							        </div>
							        <div class="col-xs-2  ">
								...
								<div class="row">
									...
									<div class="col-xs-1 text-center">
									   <p><?php $var ='paw_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':''):''; ?></p>
									</div>
									<div class="col-xs-1 text-center">
									   <p><?php $var ='paw_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'No':''):''; ?></p>
									</div>
									<div class="col-xs-2  ">
								...
								<div class="row">
									...
									<div class="col-xs-1 text-center">
										<p><?php $var ='mcr_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':''):''; ?></p>
									</div>
									<div class="col-xs-1 text-center">
										<p><?php $var ='mcr_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'No':''):''; ?></p>
									</div>
									<div class="col-xs-2  ">
							  ...
							  <?php
								...
								<div class="row">
									...
									<div class="col-xs-1 text-center">
										<p><?php $var ='fu_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':''):''; ?></p>
									</div>
									<div class="col-xs-1 text-center">
										<p><?php $var ='fu_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'No':''):''; ?></p>
									</div>
									<div class="col-xs-2  ">
							   ...
							   <?php
								...
								<div class="row">
									...
									<div class="col-xs-1 text-center">
									   <p><?php $var ='cpw_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':''):''; ?></p>
									</div>
									<div class="col-xs-1 text-center">
									   <p><?php $var ='cpw_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'No':''):''; ?></p>
									</div>
									<div class="col-xs-2  ">
