	...
	<body>
		...
		<div class="container-fluid">
			...
			<?php 
				...
				/* if($allPlans[0]["driver"] != "" && $allPlans[0]["vehicle"] != ""){
					$action = $basePath."plans/undo_pd_approved";
				}else{ */
					$action = $basePath."plans/pd_approved";
				/* } */
			...
			<div class="row" style="background: #0B7D05 none repeat scroll 0% 0%;">
				<div style="text-align: right;padding-top: 5px;padding-bottom: 5px;" class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
					<?php /* if($allPlans[0]["driver"] != "" && $allPlans[0]["vehicle"] != ""){ ?>
		...
		<script type="text/javascript">
			$(function () {
				...
				$(document).on('click','#previewplanbtn',function(eve){
					...
					if(!(isemptyfield)){						
						$.post('<?php echo $basePath.'plans/pd_approve_preview'; ?>', $('#myform').serialize(), function (data, textStatus) {
							console.log(data);
