				      	...
				      	<?php 							
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">
								...
								<div class="col-xs-1 ">
										<p><?php $var ='hc_r'.$i.'_f2'; echo isset($DataRow)?$DataRow->$var:''; ?></p>				          		
								</div>
								<div class="col-xs-1 text-right">
									<label class="pt7 pb2">On ELISA</label>
								</div>
								<div class="col-xs-1 ">
									<p><?php $var ='hc_r'.$i.'_f3'; echo isset($DataRow)?$DataRow->$var:''; ?></p>				          		
								</div>
								<div class="col-xs-1 text-right">
									<label class="pt7 pb2">On PCR</label>
								</div>
								<div class="col-xs-1 ">
									<p><?php $var ='hc_r'.$i.'_f4'; echo isset($DataRow)?$DataRow->$var:''; ?></p>
								</div>
								<?php } ?>
					      	</div>
							<?php 	} ?>
					...
					<div class="row" style="background: #0B7D05 none repeat scroll 0% 0%;">
						<div  style="text-align: right;padding-top: 5px;padding-bottom: 5px;" class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
							<?php if($DataRow->submitted_by==$userId){ ?>
								<a class="btn btn-primary btn-md btncc" href="<?php echo $basePath; ?>imc/forms/hepatitis_edit/<?php echo $vpvc_id; ?>">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#compare_btn").on('click',function(e){
					window.location.href="<?php echo $basePath; ?>imc/forms/hepatitis_compare?current=<?php echo $vpvc_id; ?>&compareto="+$("#p_month").val();
				});
			});		
		</script>
	</body>
