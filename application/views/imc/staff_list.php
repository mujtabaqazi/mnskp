...
<html>
	<head>
		...
		<title>Available Staff Trained In The Areas || List</title>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="bgrowlis">
						<p>Available Staff Trained In The Areas</p> 
					</div>
				</div>
			</div>		
			<div class="filters">
			...
			<br>
			<?php echo getListingTable($tableData,"imc/forms/staff"); ?>
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>imc/ajax_calls/staff",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>imc/ajax_calls/staff/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
