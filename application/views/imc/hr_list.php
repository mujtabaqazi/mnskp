...
<html>
	<head>
		...
		<title>Human Resource || List</title>
	...
	<body>
		...
		<div class="container-fluid">
			...
			<br>
			<?php echo getListingTable($tableData,"imc/forms/hr"); ?>
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>imc/ajax_calls/hr",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>imc/ajax_calls/hr/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
