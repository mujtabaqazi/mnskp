											...
											<div class="col-sm-6 br text-center">
												...
												<div class="row bt">
													<div class="col-xs-2 br text-center ">
													  <label class="pt14 pb7">WMO</label>
													</div>
													<div class="col-xs-2 br text-center">
													  <label class="pt14 pb7">MO</label>
													</div>
													...
													<div class="col-xs-2 text-center">
													  <label class="pt14 pb7">Others </label>
													</div>
												</div>
											</div>
											<div class="col-sm-6 br text-center">
									...
									<div class="col-xs-10">
										<div class="row">
											...
											<div class="col-xs-1 text-center bg3">
												<p><?php $var="staff_r".$i."_f1"; echo isset($CompareRow)?$CompareRow->$var:'';?></p>
											</div>
											<div class="col-xs-1 text-center bg3">
												<p><?php $var="staff_r".$i."_f2"; echo isset($CompareRow)?$CompareRow->$var:'';?></p>
											</div>
											<div class="col-xs-1 text-right bg3">
												<p><?php $var="staff_r".$i."_f3"; echo isset($CompareRow)?$CompareRow->$var:'';?></p>
											</div>
											<div class="col-xs-2 text-center bg3">
												<p><?php $var="staff_r".$i."_f4"; echo isset($CompareRow)?$CompareRow->$var:'';?></p>
											</div>
											<div class="col-xs-1 text-center bg3">
												<p><?php $var="staff_r".$i."_f5"; echo isset($CompareRow)?$CompareRow->$var:'';?></p>
											</div>
										</div>
									</div>
								</div>
