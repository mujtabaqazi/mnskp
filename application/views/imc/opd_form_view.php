					...
					<div class="rowlightbg"> 
						...
						<div class="row">
							...
							<div class="col-xs-1  text-left">
								<?php if($i<3){ ?>
								<p> <?php $var ='opd_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var == 1 ? "Good" : ($DataRow->$var == 0 ? "Average" : ($DataRow->$var == 2 ? "Poor" : "")):''; ?></p>
								<?php }else {?>
								<p><?php $var ='opd_r'.$i.'_f1';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								<?php } ?>
							</div>
						</div>
						<?php 	} ?>
						...
						<div class="row">
							...
							<div class="col-xs-1">
								<p><?php $var ='ia_r2_f5';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
					...
					<div class="row" style="background: #0B7D05 none repeat scroll 0% 0%;">
						<div  style="text-align: right;padding-top: 5px;padding-bottom: 5px;" class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
							<?php if($DataRow->submitted_by==$userId){ ?>
								<a class="btn btn-primary btn-md btncc" href="<?php echo $basePath; ?>imc/forms/opd_edit/<?php echo $vpvc_id; ?>">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#compare_btn").on('click',function(e){
					window.location.href="<?php echo $basePath; ?>imc/forms/opd_compare?current=<?php echo $vpvc_id; ?>&compareto="+$("#p_month").val();
				});
			});		
		</script>
	</body>
