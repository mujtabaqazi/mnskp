...
<html>
	<head>
	  ...
	  <title>HIV-AIDS Control Services || Form</title>
	...
	<body>
		...
		<div class="container">
			<div class="panel panel-primary">
				<div class="panel-heading text-center">HIV-AIDS Control Services Checklist</div>
				<div class="panel-body pbody">
					<?php 
					echo validation_errors();
					$action = $basePath."imc/hivaid/save/";
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
				        	<div class="col-xs-12 bgcolcl text-center">
				          		 <label>HIV-AIDS Control Services</label><span> (Check Lab Register & office record. To fill this section use HF data of previous month)</span>
				        	</div>
				      	</div>
						<?php 							
						$labels = array(
							"Total number of suspected cases for AIDS registered",
							"Total number of cases referred for screening", 
							"Number of feedback received ",
							"Total number of STD cases screened ",
							"Number of +ve cases ",
							"STD Clinic/Surveillance Center established ",
							"Syndromic Management protocol followed "
						); 
						...
						<div class="row">
							...
							<div class="col-xs-2 zp">
								<?php if($i<6){ ?>
								<input value="<?php $var ='hiv_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots" type="text">				          		
								<?php }else { ?>
								<div class="row">
									<div class="col-xs-6 text-right">
										<label>Yes</label>&nbsp;
										<input <?php $var ='hiv_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="1" class="mt9" type="radio">
									</div>
									<div class="col-xs-6">
										<label>No</label>&nbsp;
										<input <?php $var ='hiv_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="0" class="mt9" type="radio">
									</div>
								</div>
								<?php } ?>
							</div>
