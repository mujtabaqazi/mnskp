					...
					<div class="rowlightbg"> 
						...
						<div class="row">
							...
							<div class="col-xs-1 text-center ">
								<input <?php $var ='med_r'.$i.'_f1';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
							...
							<div class="col-xs-1 text-center ">
								<input <?php $var ='med_r'.$i.'_f3';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
						...
						<div class="row">
							...
							<div class="col-xs-1 text-center ">
								<input <?php $var ='vac_r'.$i.'_f1';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
							...
							<div class="col-xs-1 text-center ">
								<input <?php $var ='vac_r'.$i.'_f3';?> name="<?php echo $var; ?>" value="0" class="mt9" type="hidden">
