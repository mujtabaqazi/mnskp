	...
	<body class="flat-blue">
						...
						<div class="row animated fadeInUp">
							<div class="col-xs-12">
								<div class="card">
									<div class="card-body">
										<div class="row">
											<div id="ep-num-fac" class="col-xs-8">EPI Services Availablility (Item Wise) chart will render here</div>
											<div class="col-xs-4 zp">
												<div class="row zp">
													<div id="ep-score-fac-pie" class="col-xs-12 zp">EPI Services Availablility (Percentage Wise) Pie chart will render here</div>
												</div>
												<div class="row zp">
													<div id="ep-score-fac-bar" class="col-xs-12 zp">EPI Services Availablility (Percentage Wise) Bar chart will render here</div>
												</div>
											</div>											
										</div>
									</div>
		...
		<script type="text/javascript">
			...
			FusionCharts.ready(function () {
				...
				singleserieschart(
					'ep-num-fac',
					"EPI Services Availablility",
					"EPI Services (Item Wise)",
					<?php echo isset($eptools_cats)?json_encode($eptools_cats):'[]'; ?>,
					"Facilities With EPI Services Available",
					<?php echo isset($eptools_num)?json_encode($eptools_num):'[]'; ?>,
					'# of Facilities'
				);
				//
				singleseriescolouredchart(
					...
					'ep-score-fac-pie',
					"EPI Services Availablility",
					"EPI Services %age (Section Wise)",
					<?php echo isset($epscores_cats)?json_encode($epscores_cats):'[]'; ?>,
					"Facilities With EPI Services Available",
					<?php echo isset($epscores_num)?json_encode($epscores_num):'[]'; ?>,
					'Facilities'
				);
				//
				singleseriescolouredchart(
					...
					"EPI Services %age (Section Wise)",
					<?php echo isset($epscores_cats)?json_encode($epscores_cats):'[]'; ?>,
					"Facilities With Tools/Services Available",
					<?php echo isset($epscores_num)?json_encode($epscores_num):'[]'; ?>,
					'Facilities'
				);				
			});
