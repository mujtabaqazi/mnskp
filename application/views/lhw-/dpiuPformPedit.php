   ...
   <div class="panel-body pbody">
      ...
      <div class="row">
		...
		<div class="row">
			...
			<div class="col-xs-3">
				<input value="<?php $var ="dov"; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" id="<?php echo $var; ?>" class="dp1 form-control text-center" type="text">
			</div>
        </div>
					<div class="row">
							<div class="col-xs-6">
		...
		<div class="row">
			...
			<div class="col-xs-3">
				<input value="<?php $var ="fmonth"; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" required="required" class="form-control" readonly="readonly" type="text" >
			</div>
			<div class="col-xs-3 cmargin27">
			...
			{?>
				<div class="row">
					...
					<div class="col-xs-2 zp">
						<input value="<?php $var ='mtng_r'.$i.'_f1'; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate " type="text">
					</div>
					<div class="col-xs-2 zp">
		...
		<div class="row">
			<div class="col-xs-1 zp">
				<input value="<?php $var ='lhs_r1_f1'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots noDots" type="text">
			</div>
			<div class="col-xs-1 zp">
				<input value="<?php $var ='lhs_r1_f2'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots noDots" type="text">
			</div>
			<div class="col-xs-1 zp">
				<input value="<?php $var ='lhs_r1_f3'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots noDots" type="text">
			</div>
			<div class="col-xs-1 zp">
				<input value="<?php $var ='lhs_r1_f4'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots noDots" type="text">
			</div>
			<div class="col-xs-2 zp">
				<input value="<?php $var ='lhs_r1_f5'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots noDots" type="text">
			</div>
			<div class="col-xs-2 zp">
				<input value="<?php $var ='lhs_r1_f6'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots noDots" type="text">
			</div>
			<div class="col-xs-3">
				<div class="row">
					<div class="col-xs-3 zp">
        ...
        <div class="row">
         ...
         <div class="row">
          ...
          <div class="col-xs-2 zp">
            <input value="<?php $var ='fin_r5_f1'; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
		</div>
          <div class="col-xs-4 zp">
        ...
        <div class="row">
          ...
          <div class="col-xs-2 zp">
            <input value="<?php $var ='fin_r9_f1'; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
			</div>
          <div class="col-xs-4 zp">
		...
		<?php 
			...
			for($i=1;$i<=count($labels);$i++){ ?>
				<div class="row">
					...
					<div class="col-xs-1 zp">
						<input value="<?php $var ='trng_r'.($i).'_f2'; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control zp text-center anyOtherDate" type="text">            
					</div>
					<div class="col-xs-2 zp">
						<input value="<?php $var ='trng_r'.($i).'_f3'; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
					</div>
					<div class="col-xs-4 zp">
    ...
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-xs-2">
            <input value="<?php $var ='dod'; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
			</div>
          <div class="col-xs-2 cmargin27">
