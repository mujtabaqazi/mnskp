...
<html>
	<head>
		...
		<title>District Tour Report || List</title>
	...
	<body>
		...
		<div class="container container-listing">
			...
			<br>
			<?php echo getListingTable($tableData,"lhw/forms/dtr"); ?>
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>lhw/ajax_calls/dtr",
						dataType: "json",
					...
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>lhw/ajax_calls/dtr/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
