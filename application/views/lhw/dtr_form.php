			...
			<div class="panel panel-primary">
				...
				<div class="panel-body pbody">
					...
					<div class="row">
							...
							<div class="col-xs-5">
								<input class="form-control dp" id="remarks" name="remarks" type="text" value="<?php $var ="remarks"; echo isset($DataRow)?$DataRow->$var:''; ?>" >
							</div>
				...
				<?php 
					...
					for($i=1;$i<=count($labels);$i++){ ?>
						<div class="row">
						  ...
						  <div class="col-xs-2 zp">
							<input class="form-control numberclass noDots" name="<?php echo 'v_r'.($i).'_f1'; ?>" placeholder="" type="text">
						  </div>
						  <div class="col-xs-2 zp">
							<input class="form-control numberclass noDots" name="<?php echo 'v_r'.($i).'_f2'; ?>" placeholder="" type="text">
						  </div>
						  <div class="col-xs-2 zp">
							<input class="form-control numberclass noDots" name="<?php echo 'v_r'.($i).'_f3'; ?>" placeholder="" type="text">
						  </div>
						  <div class="col-xs-3 zp">
							<input class="form-control" name="<?php echo 'v_r'.($i).'_f4'; ?>" placeholder="" type="text">
						  </div>
						</div><?php 
					} 
				?>
				...
				<div class="row">
					...
					<div class="col-xs-10 zp">
						<input class="form-control" name="<?php echo 'ms_1'; ?>" placeholder="" type="text">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-2 cmargin27 text-center">
					...
					<div class="col-xs-10 zp">
						<input class="form-control" name="<?php echo 'ms_2'; ?>" placeholder="" type="text">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-2 cmargin27 text-center">
					...
					<div class="col-xs-10 zp">
						<input class="form-control" name="<?php echo 'ms_3'; ?>" placeholder="" type="text">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-2 cmargin27 text-center">
					...
					<div class="col-xs-10 zp">
						<input class="form-control" name="<?php echo 'ms_4'; ?>" placeholder="" type="text">
					</div>
				</div>
				<div class="row bc mt1 mb1">
				   <div class="col-xs-12">
				...
				<div class="row">
					...
					<div class="col-xs-10 zp">
						<input class="form-control" name="<?php echo 'ci_1'; ?>" placeholder="" type="text">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-2 cmargin27 text-center">
					...
					<div class="col-xs-10 zp">
						<input class="form-control" name="<?php echo 'ci_2'; ?>" placeholder="" type="text">
					</div>
				</div>
				<div class="row">
					<div class="col-xs-2 cmargin27 text-center">
					...
					<div class="col-xs-10 zp">
						<input class="form-control" name="<?php echo 'ci_3'; ?>" placeholder="" type="text">
					</div>
				</div>
				<hr>
				<div class="row">
				  ...
				  <div class="col-xs-2">
					<input type="hidden" name="dpiu" id="dpiu" required="required" class="form-control" value="<?php echo isset($vpvcDataRow)?$vpvcDataRow->distcode:''; ?>" >
					<label class="pt7 pb2"><?php echo isset($vpvcDataRow)?$vpvcDataRow->district:''; ?></label>
					<!--<select name="dpiu" id="dpiu" required="required" class="form-control text-center">
						<?php //echo getDistricts_options(false,(isset($DataRow)?$DataRow->dpiu:0)); ?>
					</select>-->
				  </div>
				  <div class="col-xs-2 col-xs-offset-1 pt7">
				...
				<div class="row">
				  ...
				  <div class="col-xs-2">
					<input value="<?php echo isset($vpvcDataRow)?date("d-m-Y",strtotime($vpvcDataRow->visitdate)):''; ?>" <?php $var ="dov"; ?> name="<?php echo $var; ?>" id="<?php echo $var; ?>" class="dp1 form-control" type="text">
				  </div>
				</div>
