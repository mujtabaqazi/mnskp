  ...
  <div class="panel-body pbody">
    ...
    <div class="rowlightbg">
      <div class="row">
          ...
          <div class="col-xs-2">
            <input class="form-control numberclass noDots" id="visit_numb" name="visit_numb" type="text">
          </div>
          <div class="col-xs-2">
          ...
          <div class="col-xs-2">
            ...
            <!-- <input class="form-control dp" id="dov" name="dov" readonly="readonly" value="<?php echo (isset($vpvcDataRow))?date('d-m-Y',strtotime($vpvcDataRow->visitdate)):''; ?>" type="text"> -->
          </div>
          <div class="col-xs-2">
            <label class="pt7 pb2">District:</label>
          </div>
          <div class="col-xs-2">
          	 <input class="form-control" id="distcode" name="distcode" value="<?php echo (isset($vpvcDataRow))?$vpvcDataRow->distcode:''; ?>" type="hidden">
            <p class="pt7"><?php echo (isset($vpvcDataRow))?$vpvcDataRow->district:''; ?></p>
          </div>
      </div>
      <div class="row">
          <div class="col-xs-2">
          ...
          <div class="col-xs-2">
          	<input class="form-control" id="facode" name="facode" value="<?php echo (isset($vpvcDataRow))?$vpvcDataRow->facode:''; ?>" type="hidden">
            <p class="pt7"><?php echo (isset($vpvcDataRow))?$vpvcDataRow->facility:''; ?></p>
          </div>
          <div class="col-xs-2">
            <label class="pt7 pb2">Reporting Month:</label>
          </div>
          <div class="col-xs-2">
          	<input class="form-control" id="fmonth" name="fmonth" value="<?php echo (isset($vpvcDataRow))?$vpvcDataRow->fmonth:''; ?>" type="hidden">
            <p class="pt7"><?php echo (isset($vpvcDataRow))?$vpvcDataRow->fmonth:''; ?></p>
          </div>
          <div class="col-xs-2">
          	<label class="pt7 pb2">Supervisor Name:</label>
          </div>
          <div class="col-xs-2">
          	<input class="form-control" id="supervisor_name" name="supervisor_name" value="<?php echo (isset($vpvcDataRow))?$vpvcDataRow->supervisor_name:''; ?>" type="hidden">
            <p class="pt7"><?php echo (isset($vpvcDataRow))?$vpvcDataRow->supervisor_name:''; ?></p>
          </div>
      </div>
      <div class="row">
          <div class="col-xs-2">
          ...
          <div class="col-xs-2">
          	<input class="form-control" id="facode" name="facode" value="<?php echo (isset($vpvcDataRow))?$vpvcDataRow->supervisor_desg:''; ?>" type="hidden">
            <p class="pt7"><?php echo (isset($vpvcDataRow))?$vpvcDataRow->supervisor_desg:''; ?></p>
          </div>
          <div class="col-xs-2">
          ...
          <div class="col-xs-8">
            <div class="row">
              <div class="col-xs-4 zp">
              	<?php if($key != 'co'){ ?>
                <input class="form-control numberclass noDots" id="<?php echo $key; ?>_office_numb" name="<?php echo $key; ?>_office_numb" type="text">
                <?php }else{ ?>
                	<input class="form-control" readonly="readonly" type="text">
                <?php } ?>
              </div>
              <div class="col-xs-4 zp">
                <input class="form-control numberclass noDots" id="<?php echo $key; ?>_mob_numb" name="<?php echo $key; ?>_mob_numb" type="text">
              </div>
              <div class="col-xs-4 zp">
                <input class="form-control" id="<?php echo $key; ?>_email" name="<?php echo $key; ?>_email" type="email">
              </div>
            </div>
          </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="disthf_r1_f1" name="disthf_r1_f1" type="text">
        </div>
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="disthf_r1_f2" name="disthf_r1_f2" type="text">
        </div>
      </div>
      <div class="row">
        <div class="col-xs-4">
        ...
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="disthf_r2_f1" name="disthf_r2_f1" type="text">
        </div>
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="disthf_r2_f2" name="disthf_r2_f2" type="text">
        </div>
      </div>
      <div class="row bc mt1">
        <div class="col-xs-4">
      ...
      <div class="row">
        ...
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="dhishf_r1_f1" name="dhishf_r1_f1" type="text">
        </div>
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="dhishf_r1_f2" name="dhishf_r1_f2" type="text">
        </div>
      </div>
      <div class="row">
        <div class="col-xs-4">
        ...
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="dhishf_r2_f1" name="dhishf_r2_f1" type="text">
        </div>
        <div class="col-xs-4 zp">
          <input class="form-control numberclass noDots" id="dhishf_r2_f2" name="dhishf_r2_f2" type="text">
        </div>
      </div>
      ...
      foreach($labelArrayNew as $key => $val){
	  	if(array_key_exists($key, $yesNoKeysArray)){ ?>
	  		<div class="row" <?php echo (array_key_exists($key, array_fill_keys(array('8','9','10','11','13','14','19','20'),'yes')) == true)?'style="background:white;"':''; ?> >
		        <div class="col-xs-1">
		          <label class="pt7"><?php if(array_key_exists($key, array_fill_keys(array('8','9','10','11','13','14','19','20'),'yes')) == false){ echo $i; $i++; } ?></label>
		        </div>
		        <div class="col-xs-9">
		           <label class="pt7"><?php echo $val; ?></label>
		        </div>
		        <div class="col-xs-2 zp">
		           <div class="row">
		              <div class="col-xs-6 text-right">
		                <label>Yes</label>&nbsp;
		                <input name="hop_c1_r<?php echo $key; ?>" value="1" class="mt9" type="radio">
		              </div>
		              <div class="col-xs-6">
		                <label>No</label>&nbsp;
		                <input name="hop_c1_r<?php echo $key; ?>" value="0" class="mt9" type="radio">
		              </div>
		            </div>
		        </div>
		      </div>
	  	<?php }elseif(array_key_exists($key, $inputKeysArray)){ ?>
		  		<div class="row">
			        ...
			        <div class="col-xs-2 zp">
			           <input class="form-control numberclass" id="hop_c1_r<?php echo $key; ?>" name="hop_c1_r<?php echo $key; ?>" type="text">
			        </div>
			      </div>
	  		<?php $i++; }else{ ?>
	  			<div class="row">
      ...
      <div class="row">
        ...
        <div class="col-xs-2 zp">
          <input class="form-control" id="res_r<?php echo $j; ?>_f1" name="res_r<?php echo $j; ?>_f1" type="text">
        </div>
        <div class="col-xs-2 zp">
          <input class="form-control" id="res_r<?php echo $j; ?>_f2" name="res_r<?php echo $j; ?>_f2" type="text">
        </div>
        <div class="col-xs-2 zp">
          <input class="form-control" id="res_r<?php echo $j; ?>_f3" name="res_r<?php echo $j; ?>_f3" type="text">
        </div>
        <div class="col-xs-1 zp">
          <div class="row">
              <div class="col-xs-6 zp text-center">
                <label>Y</label> 
                <input name="res_r<?php echo $j; ?>_f4" value="1" class="mt9" type="radio">
              </div>
              <div class="col-xs-6 zp text-center">
                <label>N</label>
                <input name="res_r<?php echo $j; ?>_f4" value="0" class="mt9" type="radio">
              </div>
            </div>
        </div>
        <div class="col-xs-2 zp">
          <input class="form-control" id="res_r<?php echo $j; ?>_f5" name="res_r<?php echo $j; ?>_f5" type="text">
        </div>
        <div class="col-xs-2 zp">
           <input class="form-control" id="res_r<?php echo $j; ?>_f6" name="res_r<?php echo $j; ?>_f6" type="text">
        </div>
      </div>
      <?php } ?>
    </div>
      ...
      <div class="row" style="background: #0B7D05 none repeat scroll 0% 0%;">
        ...
        <a class="btn btn-primary btn-md btncc" href="http://checklists.dhissindh.pk/epi/listing/activities"><i class="fa fa-times"></i> Cancel </a>
            </div>
        </div>
     <?php echo form_close(); ?>
