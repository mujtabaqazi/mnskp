		...
		<script type="text/javascript">
			$(document).ready(function() {
				...
				$(document).on('click',".DrillDownRow", function(){
					var code = '<?php echo $distcode; ?>';
					var ptype = $(this).find("td:nth-child(2)").text();
					var url = '';
					var year = '<?php echo $year; ?>';
					//if(code > 0)
					{
						//mean code is district code, ptype is program type
						url = '<?php echo $basePath; ?>'+"Compliances/sup-visits-chklsts/"+code+"/"+year+"/"+ptype+"/"+'<?php echo $month; ?>';      
					}
					if(url != '')
					{
