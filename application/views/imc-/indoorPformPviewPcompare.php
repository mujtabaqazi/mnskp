							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										...
										<div class="col-xs-6">
											<?php if($i<3){ ?>
											<p class ="<?php $var ='indm_r'.$i.'_f1'; echo get_ngap_class($DataRow->$var); ?>" style="padding-top: 7px;">
											<?php $var ='indm_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var == 1 ? "Good" : ($DataRow->$var == 0 ? "Average" : ($DataRow->$var == 2 ? "Poor" : "")):''; ?></p>
											<?php }else {?>
											<p class =" pt7 <?php $var ='indm_r'.$i.'_f1'; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='indm_r'.$i.'_f1';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
											<?php } ?>
										</div>
									</div>											
								</div>
								<div class="col-xs-2 text-center bg3">
									<div class="row">
										...
										<div class="col-xs-6">
											<?php if($i<3){ ?>
											<p class ="<?php $var ='indm_r'.$i.'_f1'; echo get_ngap_class($CompareRow->$var); ?>" style="padding-top: 7px;">
											<?php $var ='indm_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Good" : ($CompareRow->$var == 0 ? "Average" : ($CompareRow->$var == 2 ? "Poor" : "")):''; ?></p>
											<?php }else {?>
											<p class =" pt7 <?php $var ='indm_r'.$i.'_f1'; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='indm_r'.$i.'_f1';echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
											<?php } ?>
										</div>
									</div>										
								</div>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='fam_r1_f'.$i; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='fam_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>
								<?php } ?>
								<div class="col-xs-2">
									<div class="row">
										<div class="col-xs-6 text-center">
											<p><?php $var ='fam_r1_f5'; echo isset($DataRow)?$DataRow->$var:'';?></P>
										</div>
										<div class="col-xs-6 text-center">
											<p class =" pt7 <?php $var ='fam_r1_f6'; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='fam_r1_f6';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>								
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='fam_r1_f'.$i; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='fam_r1_f'.$i; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>	
								</div>
								<?php } ?>
								<div class="col-xs-2 ">
									<div class="row">
										<div class="col-xs-6 text-center">
											<p><?php $var ='fam_r1_f5'; echo isset($CompareRow)?$CompareRow->$var:'';?></P>
										</div>
										<div class="col-xs-6 text-center">
											<p class =" pt7 <?php $var ='fam_r1_f6'; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='fam_r1_f6';echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iam_r1_f'.$i; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='iam_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>	
								</div>								
								<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iam_r1_f'.$i; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='iam_r1_f'.$i; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>
								<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iam_r2_f'.$i; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='iam_r2_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>								
								<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iam_r2_f'.$i; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='iam_r2_f'.$i; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>	
								</div>
								<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										...
										<div class="col-xs-6">
											<?php if($i<3){ ?>
											<p class ="<?php $var ='indf_r'.$i.'_f1'; echo get_ngap_class($DataRow->$var); ?>" style="padding-top: 7px;">
											<?php $var ='indf_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var == 1 ? "Good" : ($DataRow->$var == 0 ? "Average" : ($DataRow->$var == 2 ? "Poor" : "")):''; ?></p>
											<?php }else {?>
											<p class =" pt7 <?php $var ='indf_r'.$i.'_f1'; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='indf_r'.$i.'_f1';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
											<?php } ?>
										</div>
									</div>											
								</div>
								<div class="col-xs-2 text-center bg3">
									<div class="row">
										...
										<div class="col-xs-6">
											<?php if($i<3){ ?>
											<p class ="<?php $var ='indf_r'.$i.'_f1'; echo get_ngap_class($CompareRow->$var); ?>" style="padding-top: 7px;">
											<?php $var ='indf_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Good" : ($CompareRow->$var == 0 ? "Average" : ($CompareRow->$var == 2 ? "Poor" : "")):''; ?></p>
											<?php }else {?>
											<p class =" pt7 <?php $var ='indf_r'.$i.'_f1'; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='indf_r'.$i.'_f1';echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
											<?php } ?>
										</div>
									</div>											
								</div>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='faf_r1_f'.$i; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='faf_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>									
										</div>
									</div>	
								</div>								
								<?php } ?>
								<div class="col-xs-2">
									<div class="row">
										<div class="col-xs-6 text-center">
											<p class="pt7"><?php $var ='faf_r1_f5'; echo isset($DataRow)?$DataRow->$var:'';?></P>
										</div>
										<div class="col-xs-6 text-center">
											<p class =" pt7 <?php $var ='faf_r1_f6'; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='faf_r1_f6';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>								
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6"> 
											<p class =" pt7 <?php $var ='faf_r1_f'.$i; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='faf_r1_f'.$i; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>									
										</div>
									</div>
								</div>
								<?php } ?>								
								<div class="col-xs-2 ">
									<div class="row">
										<div class="col-xs-6 text-center">
											<p class="pt7"><?php $var ='faf_r1_f5'; echo isset($CompareRow)?$CompareRow->$var:'';?></P>
										</div>
										<div class="col-xs-6 text-center">
											<p class =" pt7 <?php $var ='faf_r1_f6'; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='faf_r1_f6';echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iaf_r1_f'.$i; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='iaf_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>								
								<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iaf_r1_f'.$i; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='iaf_r1_f'.$i; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>	
								</div>
								<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iaf_r2_f'.$i; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='iaf_r2_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>								
								<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										<div class="col-xs-3"></div>
										<div class="col-xs-6">
											<p class =" pt7 <?php $var ='iaf_r2_f'.$i; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='iaf_r2_f'.$i; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										</div>
									</div>
								</div>
								<?php } ?>
