		...
		<div class="container">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					$action = $basePath."imc/lhw/save/".$id;
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
				        	<div class="col-xs-12 bgcolcl text-center">
				          		<label>LHW Services</label><span> (Check Monthly Reports of LHW. To fill this section use HF data of previous month)</span>
				        	</div>
				      	</div>
				      	<?php 							
							$labels = array(
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">
					        	...
					        	<div class="col-xs-3">
					        		<input value="<?php $var ='lhw_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="<?php if($i==3)  {echo "form-control numberclass";} else {echo "form-control numberclass noDots";} ?>" type="text">				          		
					        	</div>
					      	</div><?php 
						}?>	
				      	...
				      	<?php 							
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">	
								...
								<div class="col-xs-3">
									<input value="<?php $var ='cm_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots" type="text">				          		
								</div>
					      	</div><?php 
						}?>	
						<div class="row">
				      	...
				      	<?php 							
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">	
								...
								<div class="col-xs-3">
									<input value="<?php $var ='ps_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots" type="text">				          		
								</div>
					      	</div><?php 
						}?>	
