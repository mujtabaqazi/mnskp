...
<html>
	<head>
	  ...
	  <title>Nutrition Services || Form</title>
	...
	<body>
		...
		<div class="container">
			<div class="panel panel-primary">
				<div class="panel-heading text-center">Nutrition Services Checklist</div>
				<div class="panel-body">
					<?php 
					echo validation_errors();
					$action = $basePath."imc/nutrition/save/".$id;
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
				        	<div class="col-xs-12 bgcolcl text-center">
				          		<label>Nutrition Services</label><span>(Check OPD, Child Health & Stock Register. To fill this section use HF data of previous month)</span>
				        	</div>
				      	</div>
				      	<?php 							
							$labels = array(
								'Number of children < 5 years',
								'Number of malnourished children diagnosed',
								'Number of follow up of defaulted children maintained'
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">
					        	...
					        	<div class="col-xs-4 zp">
					        		<input value="<?php $var ='ns_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control numberclass noDots" type="text">				          		
					        	</div>
					      	</div><?php 
						}?>
						...
						<div class="row">
					        <div class="col-xs-4 col-xs-offset-2">
					          <label class="pt20">Anthropometric Measurement Instrument</label>
					        </div>
					        <div class="col-xs-4  ">
							    <div class="row ">
							        <div class="col-xs-6 bc  text-center br">
						            	<label class="pt7 pb2">Available</label>
						            </div>
						            <div class="col-xs-6 bc  text-center">
						            	<label class="pt7 pb2">Functional</label>
						            </div>
							    </div>
							    <div class="row">
							        <div class="col-xs-6">
							            <div class="row">
							                <div class="col-xs-6  text-center">
							                	<label>Yes</label>&nbsp;
							                	<input <?php $var ='ns_r4_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="1" class="mt9" type="radio">
							              	</div>
							              	<div class="col-xs-6 text-left">
								                <label>No</label>&nbsp;
								                <input <?php $var ='ns_r4_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="0" class="mt9" type="radio">
							             	</div>
							            </div>
							        </div>
							        <div class="col-xs-6">
							            <div class="row">
							            	<div class="col-xs-6  text-center">
								                <label>Yes</label>&nbsp;
								                <input <?php $var ='ns_r5_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="1" class="mt9" type="radio">
							              	</div>
							              	<div class="col-xs-6 text-left">
								                <label>No</label>&nbsp;
								                <input <?php $var ='ns_r5_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="0" class="mt9" type="radio">
							              	</div>
							            </div>
							        </div>
							    </div>
