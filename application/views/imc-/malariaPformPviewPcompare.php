					...
					<div class="rowlightbg"> 
						...
						<div class="row">
				        	<div class="col-xs-12 bgcolcl text-center">
				          		<label>Malaria Control Services </label>
				        	</div>
				      	</div>
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">
					        	...
					        	<div class="col-xs-3">
					        		<div class="row">
										<div class="col-xs-6 text-center">
											<p class ="pt7"><?php $var ='mc_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?></p>				          		
										</div>
										<div class="col-xs-6 text-center">
											<p class ="pt7"><?php $var ='mc_r'.$i.'_f2'; echo isset($DataRow)?$DataRow->$var:''; ?></p>				          		
										</div>																														
									</div>
								</div>
								<div class="col-xs-3">
					        		<div class="row bg3">
										<div class="col-xs-6 text-center">
											<p class ="pt7"><?php $var ='mc_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var:''; ?></p>				          		
										</div>
										<div class="col-xs-6 text-center">
											<p class ="pt7"><?php $var ='mc_r'.$i.'_f2'; echo isset($CompareRow)?$CompareRow->$var:''; ?></p>				          		
										</div>																				
									</div>
								</div>
					      	</div><?php 
					        		...
					        		<div class="row">
										<div class="col-xs-6 text-center">
											<div class="row">
												...
												<div class="col-xs-6">
													<p class =" pt7 <?php $var ='cl_r'.$i.'_f1'; echo get_yn_class($DataRow->$var); ?>">
													<?php $var ='cl_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>
												</div>
											</div>	
										</div>
										<div class="col-xs-6 text-center bg3">
											<div class="row">
												<div class="col-xs-3"></div>
												<div class="col-xs-6">
													<p class =" pt7 <?php $var ='cl_r'.$i.'_f1'; echo get_yn_class($CompareRow->$var); ?>">
													<?php $var ='cl_r'.$i.'_f1'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>
												</div>
											</div>
										</div>																				
									</div>
