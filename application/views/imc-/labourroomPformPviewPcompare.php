...
<html>
	<head>
	  ...
	  <title>General Services - Labor Room || Form</title>
	...
	<body>
		...
		<div class="container">
			<div class="panel panel-primary">
				<div class="panel-heading text-center">General Services - Labor Room Checklist</div>
				<div class="panel-body pbody">
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
				      	...
				      	<div class="row bc">
				        	<div class="col-xs-8">
				          		<label>LABOR ROOM </label><span> (Physically check/direct observation and tick the relevant column)</span>
				        	</div>
						...
						<div class="row">
							...
							<div class="col-xs-2  text-center">
								<div class="row">
									...
									<div class="col-xs-6">
										<?php if($i<3){ ?>
										<p class ="<?php $var ='labrm_r'.$i.'_f1'; echo get_ngap_class($DataRow->$var); ?>" style="padding-top: 7px;">
										<?php $var ='labrm_r'.$i.'_f1';  echo isset($DataRow)?$DataRow->$var == 1 ? "Good" : ($DataRow->$var == 0 ? "Average" : ($DataRow->$var == 2 ? "Poor" : "")):''; ?></p>
										<?php }else {?>
										<p class =" pt7 <?php $var ='labrm_r'.$i.'_f1'; echo get_yn_class($DataRow->$var); ?>">
										<?php $var ='labrm_r'.$i.'_f1';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
										<?php } ?>
									</div>
								</div>		
							</div>
							<div class="col-xs-2  text-center bg3">
								<div class="row">
									...
									<div class="col-xs-6">
										<?php if($i<3){ ?>
										<p class ="<?php $var ='labrm_r'.$i.'_f1'; echo get_ngap_class($CompareRow->$var); ?>" style="padding-top: 7px;">
										<?php $var ='labrm_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Good" : ($CompareRow->$var == 0 ? "Average" : ($CompareRow->$var == 2 ? "Poor" : "")):''; ?></p>
										<?php }else {?>
										<p  class =" pt7 <?php $var ='labrm_r'.$i.'_f1';  echo get_yn_class($CompareRow->$var); ?>">
										<?php $var ='labrm_r'.$i.'_f1';echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
										<?php } ?>
									</div>
								</div>		
							</div>
						...
						<div class="row">
							...
							<div class="col-xs-2 text-center">
								<div class="row">
									<div class="col-xs-3"></div>
									<div class="col-xs-6">
										<p class ="<?php $var ='fa_r1_f'.$i; echo get_yn_class($DataRow->$var); ?>" style="padding-top: 7px;">
						...
						<div class="row">
							...
							<div class="col-xs-2 text-center">
								<div class="row">
									<div class="col-xs-3"></div>
									<div class="col-xs-6">
										<p class ="<?php  $var ='ia_r1_f'.$i; echo get_yn_class($DataRow->$var); ?>" style="padding-top: 7px;">
						...
						<div class="row">
							...
							<div class="col-xs-2 text-center">
								<div class="row">
									<div class="col-xs-3"></div>
									<div class="col-xs-6">
										<p class ="<?php  $var ='ia_r1_f'.$i; echo get_yn_class($CompareRow->$var); ?>" style="padding-top: 7px;">
						...
						<div class="row">
							...
							<div class="col-xs-2 text-center">
								<div class="row">
									<div class="col-xs-3"></div>
									<div class="col-xs-6">
										<p class ="<?php $var ='ia_r2_f'.$i; echo get_yn_class($DataRow->$var); ?>" style="padding-top: 7px;">
						...
						<div class="row">
							...
							<div class="col-xs-2 text-center">
								<div class="row">
									<div class="col-xs-3"></div>
									<div class="col-xs-6">
										<p class ="<?php $var ='ia_r2_f'.$i; echo get_yn_class($CompareRow->$var); ?>" style="padding-top: 7px;">
