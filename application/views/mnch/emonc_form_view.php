				...
				<div class="panel-body">
					...
					<div class="rowlightbg"> 
							...
							<div class="col-xs-3">
								<div class="row">
									<div class="col-xs-12 text-left">
										<p><?php $var ='managed_by'; echo isset($DataRow)?ucwords($DataRow->$var):''; ?></p>
									</div>
								</div>
							</div>
							<div class="col-xs-3">
						...
						<div class="row bc">
							...
							<div class="col-xs-2 text-center"><label class="pl12">Status</label></div>
							<div class="col-xs-3 bl"><label>Comments</label></div>
						</div>
						<?php 
						$keys = array(
							'2.1',
								...
								<?php if($index==8 || $index==13 || $index==21 || $index==30){}else{ ?>
									<div class="col-xs-2">
										<div class="row">
											...
											<?php }else{ ?>
												<div class="col-xs-12 text-center">
													<p><?php $var ='gmi_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>
												</div>
											<?php } ?>
										</div>
									</div>
						...
						<div class="row bc">
							...
							<div class="col-xs-2 text-center"><label>Comments</label></div>
				      	</div>						
						<?php 
						$keys = array(
							'A.',
							...
							<div class="row">
								...
								<?php if($index==1 || $index==9 || $index==14 || $index==22 || $index==25 || $index==27 || $index==34 || $index==41){}else{ ?>
									<div class="col-xs-2">
										<div class="row">											
											<div class="col-xs-12 text-center">
												<p><?php $var ='pbc_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>
											</div>											
										</div>
									</div>
									<div class="col-xs-2">
							...
							<div class="row">
								...
								<?php if($index==1 || $index==8 || $index==15 || $index==20 || $index==24){}else{ ?>
									<div class="col-xs-3">
										<div class="row">
											<div class="col-xs-12 text-center">
												<p><?php $var ='lr_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?(($i==15 || $i==16)?'Complete':'Yes'):(($i==15 || $i==16)?'Incomplete':'No')):(($i==15 || $i==16)?'Incomplete':'No'); ?></p>
											</div>
										</div>
									</div>
									<div class="col-xs-2">
							...
							<div class="row">
								...
								<?php if($index==1 || $index==8 || $index==11 || $index==14){}else{ ?>
									<div class="col-xs-3">
										<div class="row">
											<div class="col-xs-12 text-center">
												<p><?php $var ='ot_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>
											</div>
										</div>
									</div>
									<div class="col-xs-2">
						...
						<div class="row bc mt1">         
							...
							<div class="col-xs-3 brl text-center">
								<div class="row">
									<div class="col-xs-5">
										<label class="pt7">Available &#10004;</label>
									</div>
									<div class="col-xs-7 bl">
										<label class="pt7"># of days stocked out</label>
									</div>
								</div>
							</div>
								...
								<div class="col-xs-3">
									<div class="row">
										<div class="col-xs-5 text-center">
											<p><?php $var ='drg_r'.$index.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'&#10004;':'&#x2716;'):'&#x2716;'; ?></p>
										</div>
						...
						for($i = 1; $i<=count($labels); $i++){ ?>
							<div class="row">
								...
								<div class="col-xs-3 text-center">
									<p><?php $var ='ca_r'.$i.'_f3'; echo isset($DataRow)?(($DataRow->$var=="1")?'&#10004;':'&#x2716;'):'&#x2716;'; ?></p>
								</div>
							</div><?php 
						} 
						?>
								...
								<div class="col-xs-3 zp">
									<div class="row">
										<div class="col-xs-6 text-right">
											<p><?php $var ='rep_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Complete':''):'';?></p>
										</div>
										<div class="col-xs-6">
											<p><?php $var ='rep_r'.$i.'_f2'; echo isset($DataRow)?(($DataRow->$var=="1")?'Timely':''):'';?></p>
										</div>
									</div>
								</div>
								<div class="col-xs-3 zp">
					...
					<div class="row" style="background: #0B7D05 none repeat scroll 0% 0%;">
						<div  style="text-align: right;padding-top: 5px;padding-bottom: 5px;" class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
							<?php if($DataRow->submitted_by==$userId){ ?>
								<a class="btn btn-primary btn-md btncc" href="<?php echo $basePath; ?>mnch/forms/emonc_edit/<?php echo $vpvc_id; ?>">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#compare_btn").on('click',function(e){
					window.location.href="<?php echo $basePath; ?>mnch/forms/emonc_compare?current=<?php echo $vpvc_id; ?>&compareto="+$("#p_month").val();
				});
			});		
		</script>
	</body>
