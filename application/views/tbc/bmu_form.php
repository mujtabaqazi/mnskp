				...
				<div class="panel-body pbody">
					...
					<div class="rowlightbg">
						...
						<div class="row">
							...
							<div class="col-xs-2">
								<input class="form-control" id="" name="moniter_name" value="<?php $var="supervisor_name"; echo isset($vpvcDataRow)?$vpvcDataRow->$var:'';?>" type="text">
							</div>
							<div class="col-xs-2">
								<label class="pt7 pb2">Designation of Monitor</label>
							</div>
							<div class="col-xs-2">
								<input class="form-control" id="" name="moniter_desg" value="<?php $var="supervisor_desg"; echo isset($vpvcDataRow)?$vpvcDataRow->$var:'';?>" type="text">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-2">
							...
							<div class="col-xs-2">
								<input class="form-control " required id="" name="bmu_name" value="<?php $var="bmu_name"; echo isset($vpvcDataRow)?$vpvcDataRow->facility:'';?>" type="text" placeholder="" />
							</div>
							<div class="col-xs-2">
						...
						<div class="row">
							...
							<div class="col-xs-3 zp">
								<div class="row">
									<div class="col-xs-6 text-right">
										<label>Basic</label>&nbsp;
										<input <?php $var ='basic'; echo isset($DataRow)?(($DataRow->$var=="basic")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="basic" class="mt9" type="checkbox">
									</div>
									<div class="col-xs-6 text-left">
										<label>Refresher</label>&nbsp;
										<input <?php $var ='refresher'; echo isset($DataRow)?(($DataRow->$var=="refresher")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="refresher" class="mt9" type="checkbox">
									</div>
								</div>
							</div>
							<div class="col-xs-2 zp">
