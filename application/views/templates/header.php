    ...
    <div class="row" style="padding-top: 2px;">
        <div class="col-xs-12 zp">
          <ul class="userinfo">
            ...
            <li><span class="splbl">Designation:</span><span class="sptxt"><?php if($this -> session -> username == 'ddhis'){ echo "Director DHIS"; }else{ echo get_Designation_Name($this -> session -> desg); } ?></span></li>
