					...
					if (!((($ulevel=='1') || ($ulevel=='2')) && ($utype=='Admin'))) {?>
						<li class="dropdown lih">
							...
							<ul class="dropdown-menu leve1">
								...
								<?php 
								//LHW Program
								if ((($ulevel=='2') || ($ulevel=='3')) && (($utype=='Manager') || ($utype=='Executive') || ($utype=='ProExecutive') || ($utype=='DEO')) && (($ptype=='all') || ($ptype=='lhw') || ($ptype=='lhwMnchNutrition'))) {?>
									<!--LHW-->
									<li class="dropdown-submenu">
								...
								//MNCH Program
								if ((($ulevel=='2') || ($ulevel=='3')) && (($utype=='Manager') || ($utype=='Executive') || ($utype=='ProExecutive') || ($utype=='DEO')) && (($ptype=='all') || ($ptype=='mnch') || ($ptype=='lhwMnchNutrition'))) {?>
									<li class="dropdown-submenu">
								...
								if ((($ulevel=='2') || ($ulevel=='3')) && (($utype=='Manager') || ($utype=='Executive') || ($utype=='ProExecutive') || ($utype=='DEO')) && (($ptype=='all') || ($ptype=='nutrition') || ($ptype=='lhwMnchNutrition'))) {?>
									<li class="dropdown-submenu">
