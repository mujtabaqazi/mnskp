...
?>
<script>
  window.jQuery || document.write('<script src="<?php echo $basePath.'assets/js/jquery-1.11.3.min.js'; ?>"><\/script>')
</script>
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>

<script type="text/javascript" src="<?php echo $scriptsPath; ?>formValidation.min.js"></script>
<script type="text/javascript" src="<?php echo $scriptsPath; ?>formvalidation-bootstrap.min.js"></script>
...
$(document).ready(function(){
 ...
 <!--end of script for restricted date -->
<!--start of script for calendar-->
<script type="text/javascript">
    $(function () {
		...
		if($("#uncode").length == 0) {
		  //it doesn't exist
			...
			$.ajax({
				type: "POST",
				data: "tcode="+tcode,
				url: urll,//"<?php echo base_url(); ?>Common_Ajax/getUnC_options",
				success: function(result){
					$('#uncode').html(result);
					$('#uncode').trigger("change");
				}
