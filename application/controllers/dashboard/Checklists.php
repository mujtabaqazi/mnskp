...
class Checklists extends CI_Controller {
	//global arrays
	// tools and services availability
	public $srtools = array(
			...
			array('label'=>'Diary available and maintained correctly','name'=>'sr_r11_f1'),
			array('label'=>'Health Committee functional','name'=>'sr_r12_f1'),
			array('label'=>'Women Group functional','name'=>'sr_r13_f1'),
			array('label'=>'Properly uses Counseling cards for IPC','name'=>'sr_r14_f1'),
			array('label'=>'Regular visits by the vaccinator','name'=>'sr_r15_f1'),
			array('label'=>'Date of next visit of LHS known','name'=>'sr_r16_f1'),
			array('label'=>'Visits by anyone else during last one year','name'=>'sr_r17_f1'),
			array('label'=>'EPI coverage','name'=>'sr_r18_f1'),
			array('label'=>'Involved in administering routine EPI vaccines','name'=>'sr_r22_f1'),
			array('label'=>'Involved in TB-DOTS','name'=>'sr_r23_f1'),
		);
	//general outlooks
	public $gotools = array(
		...
		array('label'=>'Toilets','name'=>'toilets'),
		array('label'=>'Waste Management','name'=>'waste_mang')
	);
	...
	public $mitools = array(
		...
		array('label'=>'Condomn Register','name'=>'mia_r1_f6'),
		array('label'=>'DHIS Instruments','name'=>'mia_r1_f7')
	);
	...
	public $rctools = array(
			...
			array('label'=>'Internet','name'=>'c_r3_f1','sname'=>'c_r3_f2'),
			array('label'=>'Ambulance','name'=>'c_r4_f1','sname'=>'c_r4_f2'),
			array('label'=>'Vehicle','name'=>'c_r5_f1','sname'=>'c_r5_f2'),
			array('label'=>'Motorcycles','name'=>'c_r6_f1','sname'=>'c_r6_f2')
	);
	//General services
	public $gstools = array(
		...
		array('label'=>'Radiology','name'=>'gs_r1_f5'),
		array('label'=>'Sonology','name'=>'gs_r1_f6'),
		array('label'=>'Causality','name'=>'gs_r1_f7')
	);
	//Specific services 
	...
	//imc - DOH Facilities Checklist - Malaria Services
	...
	//imc - INDOOR WARD Male/Female section
