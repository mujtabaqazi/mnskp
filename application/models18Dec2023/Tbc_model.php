...
class Tbc_model extends CI_Model {
	//=============List all bmu records function starts=============//
	public function get_bmu_list($where = NULL, $like = NULL,$limit=null, $start=1) {
		if(!is_array($where) ){
			$where = array();
		}
		...
		$records = $this->db->get("tbc_bmu")->result_array();
		return $records;
	}
	//=============List stores records function starts=============//
	public function get_stores_list($where = NULL, $like = NULL,$limit=null, $start=1) {
		if(!is_array($where) ){
			$where = array();
		}
		$distcode = $this -> session -> distcode;
		...
		$this->db->order_by("id","DESC");
		$records = $this->db->get("tbc_stores")->result_array();
		return $records;
	}
	//=============List all mdr records function starts=============//
	public function get_mdr_list($where = NULL, $like = NULL,$limit=null, $start=1) {
		if(!is_array($where) ){
			$where = array();
		}
		$distcode = $this -> session -> distcode;
		...
		$this->db->order_by("id","DESC");
		$records = $this->db->get("tbc_mdr")->result_array();
		return $records;
	}
	//------------------count table record--------------------------------------------// 
	...
	//================== get_previous =============================//
	public function get_previous($table='tbc_stores',$wc,$checklistid=0,$facode=null,$dov=NULL,$hcptype_id=NULL,$lhwcode=NULL,$lhscode=NULL){
