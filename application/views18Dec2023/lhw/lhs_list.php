...
<html>
	<head>
		...
		<title>LHW-Lady Health Supervisors Checklist || List</title>
		...
		<div class="container container-listing">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="bgrowlis">
						<p>Checklist for Lady Health Supervisors - List</p> 
					</div>
				</div>
			</div>		
			<div class="filters">
			...
			<br>
			<?php echo getListingTable($tableData,"lhw/forms/lhs"); ?>
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>lhw/ajax_calls/lhs",
						dataType: "json",
					...
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>lhw/ajax_calls/lhs/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
