...
<div class="container">
   ...
   <div class="panel-heading text-center">Health House & Lady Health Workersss</div>
   <div class="panel-body pbody">
    ...
    <div class="rowlightbg">         
		...
		<div class="row">
			...
			<div class="col-xs-2">
				<input type="hidden" name="lhwcode" id="lhwcode" value="<?php echo isset($vpvcDataRow)?$vpvcDataRow->target_value:''; ?>" required="required" class="form-control"  readonly="readonly" >               
			...
			<div class="col-xs-2">
				<input type="text" name="service_years" id="service_years" value="1" class="form-control numberclass noDots">
			</div>
			<div class="col-xs-2 mt7">
		...
		<div class="row">
			...
			<div class="col-xs-2">
				<input value="<?php echo isset($vpvcDataRow)?date("d-m-Y",strtotime($vpvcDataRow->visitdate)):''; ?>" <?php $var ="dov"; ?> name="<?php echo $var; ?>" id="<?php echo $var; ?>" class="form-control dp1" type="text">
			</div>
		</div>
					<div class="row">
							<div class="col-xs-6">
        ...
        <div class="row">
          <div class="col-xs-3 zp">
            <input readonly="true" style="height: 170px;" value="<?php echo isset($vpvcDataRow)?$vpvcDataRow->facility:''; ?>" class="form-control" type="text">
          </div>
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-12">
