...
<html>
	...
	<body>
				...
				<div class="panel-body pbody">
					...
					<div class="rowlightbg">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<input value="<?php echo isset($vpvcDataRow)?date("d-m-Y",strtotime($vpvcDataRow->visitdate)):''; ?>" <?php $var ="dov"; ?> type="text" name="dov" id="dov" class="form-control dp1">
							</div>              
							<div class="col-xs-3 mt7">
								<label>No. of LHWs affiliated</label>
							</div>
							<div class="col-xs-3">
								<input type="text" name="lhw_attached" id="lhw_attached"  class="form-control numberclass noDots" value="">
							</div>
						</div>
					<div class="row">
							<div class="col-xs-6">
		...
		<?php 
			$labels = array(
				'i. Trained Trainers available (at least 3)',
				...
				<div class="row">
					...
					<div class="col-xs-3 <?php if($i==9){echo 'zp';} ?>">						
						<?php if($i==3 || $i == 4){?>
							...
							<input name="<?php echo 'tr_r'.$i.'_f1'; ?>" class="form-control numberclass noDots" placeholder="Number" type="text">
							<?php
						} else{ ?>
							<div class="row">
					...
					<div class="col-xs-3 zp">
						<input name="<?php echo 'tr_r'.$i.'_f2'; ?>" class="form-control" placeholder="" type="text">
					</div>
				</div><?php 
			} 
		?>
				...
				<div class="row">
					...
					<div class="col-xs-3  <?php if($i==1){echo 'zp';} ?>">
						<?php if($i==3){?>
							...
							<input name="<?php echo 'rk_r'.$i.'_f1'; ?>" class="form-control numberclass noDots" placeholder="Number" type="text">
							<?php
						} else{ ?>
							<div class="row">
								<div class="col-xs-6 text-right">
					...
					<div class="col-xs-3 zp">
						<input name="<?php echo 'rk_r'.$i.'_f2'; ?>" class="form-control" placeholder="" type="text">
					</div>
				</div><?php 
			} 
		?>
			...
			for($i=1; $i<=count($labels); $i++){?>
				<div class="row" ><?php 
					...
					<div class="col-xs-3 <?php if($i>=6 && $i<=8){echo 'zp';} ?>">
						<?php if($i>=6 && $i<=8){?>
							<input name="<?php echo 'l_r'.$i.'_f1'; ?>" class="form-control numberclass noDots" placeholder="Number" type="text">
							<?php
						} else{ ?>
							<div class="row">
								<div class="col-xs-6 text-right">
					...
					<div class="col-xs-3 zp">
						<input name="<?php echo 'l_r'.$i.'_f2'; ?>" class="form-control" placeholder="" type="text">
					</div>
				</div><?php 
			} 
			?>
		...
		<?php 
			...
			for($i=1; $i<=count($labels); $i++){?>
				<div class="row">
				  ...
				  <div class="col-xs-3 zp">
					<input name="<?php echo 'ref_r'.$i.'_f2'; ?>" class="form-control" placeholder="" type="text">
				  </div>
				</div><?php 
			} 
		?>
				...
				<div class="row">
				  ...
				  <div class="col-xs-3 <?php if($i==5){echo 'zp';} ?>">
						<?php if($i==2){?>
							...
							<input value="<?php $var ="sup_r5_f1"; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control zp text-center anyOtherDate" type="text">
							<!-- <input name="<?php echo 'sup_r'.$i.'_f1'; ?>" class="form-control dp" type="text"> -->
							<?php
						} else{ ?>
							<div class="row">
								<div class="col-xs-6 text-right">
				  ...
				  <div class="col-xs-3 zp">
					<input name="<?php echo 'sup_r'.$i.'_f2'; ?>" class="form-control" placeholder="" type="text">
				  </div>
				</div><?php 
			} 
		?>
        ...
        <div class="row">
          ...
          <div class="col-xs-2 zp">
            <input name="dis_attnd_by" style="height: 170px;" class="form-control" type="text">
          </div>
          <div class="col-xs-2 zp">
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r1_f1" class="form-control" placeholder="1" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r2_f1" class="form-control" placeholder="2" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r3_f1" class="form-control" placeholder="3" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r4_f1" class="form-control" placeholder="4" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r5_f1" class="form-control" placeholder="5" type="text">
              </div>
            </div>
          </div>
          <div class="col-xs-2 zp">
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r1_f2" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r2_f2" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r3_f2" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r4_f2" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r5_f2" class="form-control" placeholder="" type="text">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r1_f3" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r2_f3" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r3_f3" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r4_f3" class="form-control" placeholder="" type="text">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-12">
                <input name="dis_r5_f3" class="form-control" placeholder="" type="text">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-10 zp">
            <input name="<?php echo 'ci_1'; ?>" class="form-control" placeholder="" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-2 cmargin27 text-center">
          ...
          <div class="col-xs-10 zp">
            <input name="<?php echo 'ci_2'; ?>" class="form-control" placeholder="" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-2 cmargin27 text-center">
          ...
          <div class="col-xs-10 zp">
            <input name="<?php echo 'ci_3'; ?>" class="form-control" placeholder="" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-2 cmargin27 text-center">
          ...
          <div class="col-xs-10 zp">
            <input name="<?php echo 'ci_4'; ?>" class="form-control" placeholder="" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-2 cmargin27 text-center">
          ...
          <div class="col-xs-10 zp">
            <input name="<?php echo 'ci_5'; ?>" class="form-control" placeholder="" type="text">
          </div>
        </div>
