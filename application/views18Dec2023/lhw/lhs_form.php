				...
				<div class="panel-body pbody">
					...
					<div class="rowlightbg">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<input type="hidden" name="lhscode" id="lhscode" value="<?php echo isset($vpvcDataRow)?$vpvcDataRow->target_value:''; ?>" required="required" class="form-control"  readonly="readonly" >								
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<input value="<?php echo isset($vpvcDataRow)?date("d-m-Y",strtotime($vpvcDataRow->visitdate)):''; ?>" <?php $var ="dov"; ?> name="<?php echo $var; ?>" id="<?php echo $var; ?>" type="text" class="form-control dp1">
							</div>              
							<div class="col-xs-3 mt7">
										...
										if($i==13 || $i==20 || $i==30){}else{
											if($i==11){?>
												...
												<div class="row">
													...
													<div class="col-xs-6">
														<label>No</label>&nbsp;
														<input <?php $var ='ms_r'.$rownum.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="0" class="mt9" type="radio">
													</div>
												</div>
											<?php }
										}?>
