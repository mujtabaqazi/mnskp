				...
				<div class="panel-body pbody">
					...
					<div class="rowlightbg">
						...
						<div class="row">
							...
							<div class="col-xs-2">
								<input value="<?php $var ="dov"; echo isset($vpvcDataRow)?$vpvcDataRow->visitdate:''; ?>" name="<?php echo $var; ?>" id="<?php echo $var; ?>" type="text" required="required" class="form-control dp1" >               
