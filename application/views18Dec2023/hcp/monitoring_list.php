<?php
			...
			<head>
					...
					<title>HCPM Checklist || List</title>
					...
					<div class="container container-listing">
							<div class="row">	
								<div class="col-md-12 text-center">			
									<div class="bgrowlis">	
										<p>Visit Report/ Checklist of Monitoring Officers</p> 
									</div>
						</div>
							</div>
					<div class="filters">				
			...
			<?php if(isset($paging) && $paging!=""){?>
					...
					<br>			
					<?php echo getChklstListingTable($tableData,"hcp/forms/monitoring"); ?>	
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>hcp/ajax_calls/monitoring",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>hcp/ajax_calls/monitoring/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
