...
<html>
	<head>
		...
		<title>M&S || Union Council List</title>
			...
			<div class="filters"><?php 
				...
				echo form_open("",$attributes); ?>
					<div class="row">
						...
						<div class="col-xs-2">
							<select size="1" class="form-control" id="tcode" name="tcode">
			...
			<div class="filters">
				<div class="row">
					<div class="col-xs-2" style="width: 10% ! important; margin-left: 90%;">
						<a href="<?php echo $basePath; ?>setup/uc_add" class="link-add-new"><img src="<?php echo $assetsPath; ?>images/addnew.png">Add New</a>
					</div>
				</div>
			</div>
			<br>
			<?php echo getListingTableNew($tableData, "settings/Setup/uc",false,false,"",false); ?>
			<?php 
			$style1 = "";
			...
			$(document).ready(function(){
				...
				function filterdata(){
					...
					$.ajax({
						...
						url: "<?php echo $basePath; ?>settings/Setup/unioncouncil_listing",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							type:'POST',
							data: $('#filter-form').serialize(),
							url:"<?php echo $basePath; ?>settings/Setup/unioncouncil_listing/"+$(this).attr("data-ci-pagination-page"),
							dataType: "json",
							success:function(result){
								$('#tbody').html('');
								if(result != null){
