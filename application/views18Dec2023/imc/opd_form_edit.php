					...
					<div class="rowlightbg"> 
						...
						<div class="row">
							...
							<div class="col-xs-1 zp text-right">
								...
								<input <?php $var ='opd_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="1" class="mt9" type="radio">
							</div>
							<div class="col-xs-1 zp text-right">
								<label><?php echo ($i<3)?"Average":"No"; ?></label>&nbsp;
								<input <?php $var ='opd_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="0")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="0" class="mt9" type="radio">
							</div>
							<div class="col-xs-1 zp text-center">
							<?php if($i<3){ ?>
								<label>Poor</label>&nbsp;
								<input <?php $var ='opd_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="2")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="2" class="mt9" type="radio">
							<?php } ?>
							</div>
						</div>
						<?php 	} ?>
						...
						<div class="row">
							...
							<div class="col-xs-2 zp">
								<input class="form-control" id=""  placeholder="Name of Other Items" value="<?php $var ='ia_r2_f4'; echo isset($DataRow)?$DataRow->$var:'';?>" name="<?php echo $var; ?>" type="text">
							...
							<div class="col-xs-2 zp">
								<div class="row">
									<div class="col-xs-6 text-right">
										<label>Y</label>&nbsp;
										<input <?php $var ='ia_r2_f5'; echo isset($DataRow)?(($DataRow->$var=="1")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="1" class="mt9" type="radio">
									</div>
									<div class="col-xs-6 text-left">
										<label>N</label>&nbsp;
										<input <?php $var ='ia_r2_f5'; echo isset($DataRow)?(($DataRow->$var=="0")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>"  value="0" class="mt9" type="radio">
									</div>
								</div>
							</div>
						</div>
