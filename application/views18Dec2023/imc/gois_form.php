				...
				<div class="panel-body">
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<?php $tehsildata = get_Facility_Tehsil_data($vpvcDataRow->facode); ?>
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<?php $ucdata = get_Facility_UC_data($vpvcDataRow->facode); ?>
						...
						<div class="row mt1">
							<div class="col-xs-2">
								<label class="pt7 pb2">Category of facility</label>
							</div>
							<div class="col-xs-2">
						...
						<div class="row">
							...
							<div class="col-xs-2">
								<input value="<?php $var ="date_fumigation"; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control zp text-center anyOtherDate" placeholder="Date of last fumigation" type="text">
							</div>
						</div>
