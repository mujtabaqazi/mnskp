...
<html>
	<head>
		...
		<title>EPI Services Checklist || List</title>
	...
	<body>
		...
		<div class="container container-listing">
			...
			<br>
			<?php echo getListingTable($tableData,"imc/forms/epi"); ?>
<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>imc/ajax_calls/epi",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>imc/ajax_calls/epi/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
