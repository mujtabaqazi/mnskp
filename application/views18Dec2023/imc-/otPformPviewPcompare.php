							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<div class="row">
										...
										<div class="col-xs-6">
											<?php if ($i==3){?>
											<p><?php $var ='ot_r'.$i.'_f1'; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):'';  ?></P>
											<?php } else if($i<3){ ?>
											<p class ="<?php $var ='ot_r'.$i.'_f1'; echo get_ngap_class($DataRow->$var); ?>" style="padding-top: 7px;">
											<?php $var ='ot_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var == 1 ? "Good" : ($DataRow->$var == 0 ? "Average" : ($DataRow->$var == 2 ? "Poor" : "")):''; ?></p>
											<?php }else {?>
											<p class =" pt7 <?php $var ='ot_r'.$i.'_f1'; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='ot_r'.$i.'_f1';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
											<?php } ?>
										</div>
									</div>	
								</div>
								<div class="col-xs-2 text-center bg3">
									<div class="row">
										...
										<div class="col-xs-6">
											<?php if ($i==3){?>
											<p><?php $var ='ot_r'.$i.'_f1'; echo isset($CompareRow)?date("d-m-Y",strtotime($CompareRow->$var)):'';  ?></P>
											<?php } else if($i<3){ ?>
											<p class ="<?php $var ='ot_r'.$i.'_f1'; echo get_ngap_class($CompareRow->$var); ?>" style="padding-top: 7px;">
											<?php $var ='ot_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var == 1 ? "Good" : ($CompareRow->$var == 0 ? "Average" : ($CompareRow->$var == 2 ? "Poor" : "")):''; ?></p>
											<?php }else {?>
											<p class =" pt7 <?php $var ='ot_r'.$i.'_f1'; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='ot_r'.$i.'_f1';echo isset($CompareRow)?$CompareRow->$var == 1 ? "Yes" : ($CompareRow->$var == 0 ? "No" : ""):'';?></p>
											<?php } ?>
										</div>
									</div>		
								</div>								
