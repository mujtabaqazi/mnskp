			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
				        	<div class="col-xs-8 bgcolcl text-center">
				          		<label>TB Control Services</label>
				        	</div>
							<div class="col-xs-2 bgcolcl brl text-center"><label><?php $var ="fmonth"; echo isset($DataRow)?getNewFMonthFormat($DataRow->$var):''; ?></label></div>
							<div class="col-xs-2 bgcolcl text-center"><label><?php $var ="fmonth"; echo isset($CompareRow)?getNewFMonthFormat($CompareRow->$var):''; ?></label></div>
				      	</div> 
				      	<?php 							
							$labels = array(
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">
					        	...
					        	<div class="col-xs-2 text-center">
					        		<p><?php $var ='tb_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?><p>				          		
					        	</div>
								<div class="col-xs-2 text-center bg3">
					        		<p><?php $var ='tb_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var:''; ?><p>				          		
					        	</div>
					      	</div><?php 
						}?>
						<div class="row">
				        		...
				        		<div class="row">
									<div class="col-xs-6 text-center">
										<div class="row">
											...
											<div class="col-xs-6">
												<p class =" pt7 <?php $var ='tb_r7_f1'; echo get_yna_class($DataRow->$var); ?>">
												<?php $var ='tb_r7_f1'; echo isset($DataRow)?(($DataRow->$var=="2")?'Yes':(($DataRow->$var=="1")?'No':'NA')):'NA'; ?></p>																			
											</div>
										</div>
									</div>
									<div class="col-xs-6 text-center bg3">
										<div class="row">
											<div class="col-xs-3"></div>
											<div class="col-xs-6">
												<p class =" pt7 <?php $var ='tb_r7_f1'; echo get_yna_class($CompareRow->$var); ?>">
												<?php $var ='tb_r7_f1'; echo isset($CompareRow)?(($CompareRow->$var=="2")?'Yes':(($CompareRow->$var=="1")?'No':'NA')):'NA'; ?></p>																			
											</div>
										</div>
									</div>
								</div>
						...
						<div class="row bc mt1">
					        <div class="col-xs-3 col-xs-offset-1">
					        	<label class="pt14">MIS Instruments</label>
					        </div>
					        <div class="col-xs-4 brl text-center">
					        	<div class="row">
					        		...
					        		<div class="row">
										<div class="col-xs-6 text-center">
											<div class="row">
												<div class="col-xs-3"></div>
												<div class="col-xs-6">
													<p class =" pt7 <?php $var ='ms_r'.$i.'_f1'; echo get_yn_class($DataRow->$var); ?>">
													<?php $var ='ms_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>
												</div>
											</div>
										</div>
										<div class="col-xs-6 text-center">
											<div class="row">
												<div class="col-xs-3"></div>
												<div class="col-xs-6">
													<p class =" pt7 <?php $var ='ms_r'.$i.'_f2'; echo get_yn_class($DataRow->$var); ?>">
													<?php $var ='ms_r'.$i.'_f2'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>
												</div>
											</div>
										</div>																										
									</div>
									...
									<div class="row bg3">
										<div class="col-xs-6 text-center">
											<div class="row">
												<div class="col-xs-3"></div>
												<div class="col-xs-6">
													<p class =" pt7 <?php $var ='ms_r'.$i.'_f1'; echo get_yn_class($CompareRow->$var); ?>">
													<?php $var ='ms_r'.$i.'_f1'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>
												</div>
											</div>
										</div>
										<div class="col-xs-6 text-center">
											<div class="row">
												<div class="col-xs-3"></div>
												<div class="col-xs-6">
													<p class =" pt7 <?php $var ='ms_r'.$i.'_f2'; echo get_yn_class($CompareRow->$var); ?>">
													<?php $var ='ms_r'.$i.'_f2'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>
												</div>
											</div>
										</div>																
									</div>
