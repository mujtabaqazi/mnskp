								...
								for($i=1; $i<=count($labels); $i++){ ?>						
						      	<div class="row mt5">
						        	...
						        	<div class="col-xs-2 text-center">
						        		<p><?php $var ='ns_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var:''; ?></p>				          		
						        	</div>
						        	<div class="col-xs-2 text-center bg3">
						        		<p><?php $var ='ns_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var:''; ?></p>				          		
						        	</div>
						      	</div><?php 
							}?>
							<div class="row">
						        ...
						        <div class="col-xs-4  ">
								    <div class="row ">
							            ...
							            <div class="col-xs-6 bc  text-center">
							            	<label class="pt7 pb2"><?php $var ="fmonth"; echo isset($CompareRow)?getNewFMonthFormat($CompareRow->$var):''; ?></label>	
									            	<div class="row bt">
												<div class="col-xs-6 br text-center ">
												  <label>Available</label>
												</div>
								    ...
								    <div class="row">
								        <div class="col-xs-6">
								            <div class="row">
								                <div class="col-xs-6  text-center">							                	
								                	<p class =" pt7 <?php $var ='ns_r4_f1'; echo get_yn_class($DataRow->$var); ?>">
								                	<?php $var ='ns_r4_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>							                	
								              	</div>
								              	<div class="col-xs-6  text-center">								               
									                <p class =" pt7 <?php $var ='ns_r5_f1'; echo get_yn_class($DataRow->$var); ?>">
									                <?php $var ='ns_r5_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>								               
								              	</div>								              								              	
								            </div>								           
								        </div>								        
								        <div class="col-xs-6">
								            <div class="row bg3">
								            	 <div class="col-xs-6  text-center">							                	
								                	<p class =" pt7 <?php $var ='ns_r4_f1'; echo get_yn_class($CompareRow->$var); ?>">
								                	<?php $var ='ns_r4_f1'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>							                	
								              	</div>	
								              	<div class="col-xs-6  text-center">								               
									                <p class =" pt7 <?php $var ='ns_r5_f1'; echo get_yn_class($CompareRow->$var); ?>">
									                <?php $var ='ns_r5_f1'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>								               
								              	</div>							              	
								            </div>								           
								        </div>								        
								    </div>
