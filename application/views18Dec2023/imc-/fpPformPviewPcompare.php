					...
					<div class="rowlightbg">
						...
						<div class="row">
				      	...
				      	<div class="row bc mt1">
					        ...
					        <div class="col-xs-1 bl bt col-xs-offset-6 text-center">
					        	<label>Old</label>
					        </div>
					        <div class="col-xs-1 bl bt text-center">
					        	<label>New</label>
					        </div>
					        <div class="col-xs-1 bl bt text-center">
					        	<label>Total</label>
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">
					        	...
					        	<div class="col-xs-3">
					        		<div class="row">
										<div class="col-xs-4 text-center">											
											<p class =" pt7 <?php $var ='nfp_r'.$i.'_f1'; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='nfp_r'.$i.'_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>											
										</div>
										<div class="col-xs-4 text-center">											
											<p class =" pt7 <?php $var ='nfp_r'.$i.'_f2'; echo get_yn_class($DataRow->$var); ?>">
											<?php $var ='nfp_r'.$i.'_f2'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>											
										</div>
										<div class="col-xs-4 text-center">											
								...
								<div class="col-xs-3">
					        		<div class="row bg3">
					        			<div class="col-xs-4 text-center">											
											<p class =" pt7 <?php $var ='nfp_r'.$i.'_f1'; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='nfp_r'.$i.'_f1'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>											
										</div>										
										<div class="col-xs-4 text-center">											
											<p class =" pt7 <?php $var ='nfp_r'.$i.'_f2'; echo get_yn_class($CompareRow->$var); ?>">
											<?php $var ='nfp_r'.$i.'_f2'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>											
										</div>
										<div class="col-xs-4 text-center">											
											<p><?php $var ='nfp_r'.$i.'_f3'; echo isset($CompareRow)?$CompareRow->$var:''; ?></p>
										</div>							
									</div>
								</div>
					    ...
					    <div class="row bc">
							...
							<div class="col-xs-2 text-center"><label><?php $var ="fmonth"; echo isset($CompareRow)?getNewFMonthFormat($CompareRow->$var):''; ?></label></label></div>
				      	</div>
				      	<?php 							
							$labels = array(
								'Condoms',
							...
							for($i=1; $i<=count($labels); $i++){ ?>						
					      	<div class="row">
					        	...
					        	<div class="col-xs-2 text-center bg3" >
					        		<p><?php $var ='fp_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var:''; ?></p>				          		
					        	</div>
					      	</div>
					      	<?php 
						}?>	
						...
						<div class="row bc">
							...
							<div class="col-xs-4 brl text-center"><label><?php $var ="fmonth"; echo isset($DataRow)?getNewFMonthFormat($DataRow->$var):''; ?></label></label></div>
							<div class="col-xs-4 text-center"><label><?php $var ="fmonth"; echo isset($CompareRow)?getNewFMonthFormat($CompareRow->$var):''; ?></label></label></div>
				      	</div>
				      	<div class="row">
