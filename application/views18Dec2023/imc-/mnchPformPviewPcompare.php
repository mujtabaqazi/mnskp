							...
							<div class="row">
								...
								for($i=1; $i<=count($labels); $i++){ ?>						
						      	<div class="row">
						        	...
						        	<div class="col-xs-2 text-center bg3">
						        		<p><?php $var ='mch_r'.$i.'_f1'; echo isset($CompareRow)?$CompareRow->$var:''; ?></p>					        		
						        	</div>
						      	</div><?php 
							}?>	
						        ...
						        <div class="col-xs-2">
						          	<div class="row">
						            	<div class="col-xs-6 col-xs-offset-3 text-center">
						                	<p class =" pt7 <?php $var ='mch_r8_f1'; echo get_yn_class($DataRow->$var); ?>">
						                	<?php $var ='mch_r8_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>					                						             		
						              	</div>
						            </div>
					        	</div>
					        	<div class="col-xs-2">
						          	<div class="row bg3">
						            	<div class="col-xs-6 col-xs-offset-3 text-center">
						                	<p class =" pt7 <?php $var ='mch_r8_f1'; echo get_yn_class($CompareRow->$var); ?>">
						                	<?php $var ='mch_r8_f1'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>					                						             		
						              	</div>
						            </div>
					        	</div>
					      	</div>
					      	<div class="row">
						        ...
						        <div class="col-xs-2">
						        	<div class="row">
						            	<div class="col-xs-6 col-xs-offset-3 text-center">
						                	<p class =" pt7 <?php $var ='mch_r9_f1'; echo get_yn_class($DataRow->$var); ?>">
						                	<?php $var ='mch_r9_f1'; echo isset($DataRow)?(($DataRow->$var=="1")?'Yes':'No'):'No'; ?></p>					                	
						              	</div>
						            </div>
						        </div>
						        <div class="col-xs-2">
						        	<div class="row bg3">
						            	<div class="col-xs-6 col-xs-offset-3 text-center">
						                	<p class =" pt7 <?php $var ='mch_r9_f1'; echo get_yn_class($CompareRow->$var); ?>">
						                	<?php $var ='mch_r9_f1'; echo isset($CompareRow)?(($CompareRow->$var=="1")?'Yes':'No'):'No'; ?></p>					                	
						              	</div>
						            </div>
						        </div>
					      	</div>
