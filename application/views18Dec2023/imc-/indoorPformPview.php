						...
						<div class="rowlightbg"> 
							...
							<div class="row">
								...
								<div class="col-xs-1 text-left">
									<?php if($i<3){ ?>
									<p> <?php $var ='indm_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var == 1 ? "Good" : ($DataRow->$var == 0 ? "Average" : ($DataRow->$var == 2 ? "Poor" : "")):''; ?></p>
									<?php }else {?>
									<p><?php $var ='indm_r'.$i.'_f1';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
									<?php } ?>
							...
							<div class="row">
								...
								<div class="col-xs-2 text-center">
									<p><?php $var ='fam_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								...
								<div class="col-xs-1">
									<p><?php $var ='fam_r1_f6';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								</div>
							</div>
							<div class="row bc mt1">
								<div class="col-sm-2 bgw" style="min-height:25.5px;">
							...
							<div class="row">
								...
								<?php for ($i=1;$i<=5;$i++){?>
								<div class="col-xs-2 text-center">
									<p><?php $var ='iam_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								</div>
								<?php } ?>
							</div>
							<div class="row bc mt1">
							...
							<div class="row">
								...
								<?php for ($i=1;$i<=5;$i++){?>
								<div class="col-xs-2 text-center">
									<p><?php $var ='iam_r2_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								</div>
								<?php } ?>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-xs-1 text-left">
									<?php if($i<3){ ?>
									<p> <?php $var ='indf_r'.$i.'_f1'; echo isset($DataRow)?$DataRow->$var == 1 ? "Good" : ($DataRow->$var == 0 ? "Average" : ($DataRow->$var == 2 ? "Poor" : "")):''; ?></p>
									<?php }else {?>
									<p><?php $var ='indf_r'.$i.'_f1';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
									<?php } ?>
							...
							<div class="row">
								...
								<?php for ($i=1;$i<=4;$i++){?>
								<div class="col-xs-2 text-center">
									<p><?php $var ='faf_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
									
								</div>
								<?php } ?>
								<div class="col-xs-1 ">
									<p><?php $var ='faf_r1_f5'; echo isset($DataRow)?$DataRow->$var:'';?></P>
								</div>
								<div class="col-xs-1">
									<p><?php $var ='faf_r1_f6';echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								</div>
							</div>
							<div class="row bc mt1">
								<div class="col-sm-2 bgw" style="min-height:25.5px;">
							...
							<div class="row">
								...
								<?php for ($i=1;$i<=5;$i++){?>
								<div class="col-xs-2 text-center">
									<p><?php $var ='iaf_r1_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								</div>
								<?php } ?>
							</div>
							<div class="row bc mt1">
							...
							<div class="row">
								...
								<?php for ($i=1;$i<=5;$i++){?>
								<div class="col-xs-2 text-center">
									<p><?php $var ='iaf_r2_f'.$i; echo isset($DataRow)?$DataRow->$var == 1 ? "Yes" : ($DataRow->$var == 0 ? "No" : ""):'';?></p>
								</div>
								<?php } ?>
							</div>
					...
					<div class="row" style="background: #0B7D05 none repeat scroll 0% 0%;">
						<div  style="text-align: right;padding-top: 5px;padding-bottom: 5px;" class="col-md-5 col-md-offset-7 col-sm-6 col-sm-offset-6 col-xs-6 col-xs-offset-6">
							<?php if($DataRow->submitted_by==$userId){ ?>
								<a class="btn btn-primary btn-md btncc" href="<?php echo $basePath; ?>imc/forms/indoor_edit/<?php echo $vpvc_id; ?>">
		...
		<script type="text/javascript">
			$(document).ready(function() {
				$("#compare_btn").on('click',function(e){
					window.location.href="<?php echo $basePath; ?>imc/forms/indoor_compare?current=<?php echo $vpvc_id; ?>&compareto="+$("#p_month").val();
				});
			});		
		</script>
	</body>
