		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="bgrowlis">
						<p>Monthly Visit Plan - Approve Preview</p> 
					</div>
				</div>
			</div>		
			<div class="filters">
					...
					if($this->session->userLevel!=2){
						...
						if($statusResult == 'true'){}else{
							if(isset($app_stat) && $app_stat->approvaldate != ""){
								...
								<a class="btn btn-success btn-md" href="<?php echo $basePath."plans/dho_approve/".$fmonth; ?>"><i class="fa fa-floppy-o "></i> Edit Plan </a><?php 
							}
						}
					} ?>
