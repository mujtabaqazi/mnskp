...
(Only for Health Facility with Functional EPI Centre)
     ...
     <div class="panel-body pbody">
        ...
        <div class="row">
          ...
          <div class="col-xs-3">
            <input class="dp1 form-control" id="dov" name="dov"  value="<?php echo isset($vpvcDataRow)?date("d-m-Y",strtotime($vpvcDataRow->visitdate)):''; ?>" placeholder="date of visit" type="text"> 
          </div>
          <div class="col-xs-1 cmargin27">
            <label>1.2.</label>
          </div>
		...
		<div class="row">
          ...
          <div class="col-xs-3">
            <input class="form-control numberclass noDots" id="staff_numb" name="staff_numb" type="text" placeholder=" " />
          </div>         
          <div class="col-xs-1 cmargin27">
        <label>1.8</label>
      </div>
          ...
          <div class="col-xs-3">
            <input class="form-control numberclass noDots" id="staff_present" name="staff_present" type="text" placeholder=" " />
          </div>
          ...
          <div class="col-xs-3">
            <div class="row">
              <div class="col-xs-6 text-right">
                ...
                <input name="lvs_r<?php echo $key; ?>_f1" value="1" class="mt9" type="checkbox">
              </div>
              <div class="col-xs-6">
                <label>Last month</label>&nbsp;
                <input name="lvs_r<?php echo $key; ?>_f2" value="2" class="mt9" type="checkbox">
              </div>
            </div>
          </div>
          <div class="col-xs-3">
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="ccs_r1_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              ...
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="ccs_r2_f1" value="0" class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="ccs_r2_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              ...
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="ccs_r3_f1" value="0" class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="ccs_r3_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="ccs_r4_f2" placeholder="If yes,what non-EPI items are stored" type="text">
          </div>
        </div>
        <div class="row bc mt1 mb1">
          <div class="col-xs-1">
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes(please verify)</label>&nbsp;
                <input name="ic_r1_f1" value="1" class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="ic_r1_f1" value="0" class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="ic_r1_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes(please verify)</label>&nbsp;
                <input name="ic_r2_f1" value="1" class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="ic_r2_f1" value="0" class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="ic_r2_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row bc mt1 mb1">
          <div class="col-xs-1">
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="pa_r1_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              ...
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="pa_r2_f1" value="0" class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="pa_r2_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="pa_r3_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="pa_r4_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="pa_r5_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <div class="row">
              <div class="col-xs-6 text-right zp">
                <label>Yes(please verify)</label>&nbsp;
                <input name="pa_r5_f3" value="1" class="mt9" type="radio">
              </div>
              <div class="col-xs-6">
                <label>No</label>&nbsp;
                <input name="pa_r5_f3" value="0" class="mt9" type="radio">
              </div>
            </div>
          </div>
          <div class="col-xs-3 zp">
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control dp anyOtherDate" id="" name="mva_r2_f1"   type="text">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="mva_r3_f1"   type="text">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="mva_r5_f2" placeholder="Other (Specify)" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="mva_r6_f2" placeholder="If no, why" type="text">
          </div>
        </div>
        <div class="row">
          <div class="col-xs-1">
          ...
          <div class="col-xs-3 zp">
            <input class="form-control" id="" name="mva_r7_f2" placeholder="If no, why" type="text">
          </div>
        </div>
