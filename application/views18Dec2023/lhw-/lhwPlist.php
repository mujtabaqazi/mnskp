...
<html>
	<head>
		...
		<title>LHW-Lady Health Workers Checklist || List</title>
		...
		<div class="container container-listing">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="bgrowlis">
						<p>Checklist for Health House & Lady Health Workers - List</p> 
					</div>
				</div>
			</div>		
			<div class="filters">
			...
			<br>
			<?php echo getChklstListingTable($tableData,"lhw/forms/lhw"); ?>
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>lhw/ajax_calls/lhw",
						dataType: "json",
					...
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>lhw/ajax_calls/lhw/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
