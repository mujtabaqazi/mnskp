				...
				<div class="panel-body pbody">
					...
					<div class="rowlightbg">
						...
						<div class="row">
							...
							<div class="col-xs-2">
								<input value="<?php $var="village"; echo isset($DataRow)?$DataRow->$var:'';?>"  name="<?php echo $var;?>"class="form-control" type="text">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-2">
							...
							<div class="col-xs-2">
								<input value="<?php $var="moniter_name"; echo isset($DataRow)?$DataRow->$var:'';?> " name="<?php echo $var;?>" class="form-control" type="text">
							</div>
							<div class="col-xs-2">
								<label class="pt7 pb2">Designation of Monitor</label>
							</div>
							<div class="col-xs-2">
								<input value="<?php $var="moniter_desg"; echo isset($DataRow)?$DataRow->$var:'';?>" name="<?php echo $var;?>" class="form-control" type="text">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-2">
							...
							<div class="col-xs-2">
								<input value="<?php $var="functional_date"; echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):'';?>"  name="<?php echo $var;?>" class="form-control dp anyOtherDate" type="text">
							</div>
							...
							<div class="col-xs-2">
								<input value="<?php $var="tov"; echo isset($DataRow)?$DataRow->$var:'';?>"  name="<?php echo $var;?>"class="form-control single-input" type="text">
							</div>
							<div class="col-xs-2">
								<label class="pt7 pb2">Address of Location Site</label>
							</div>
							<div class="col-xs-2">
								<input value="<?php $var="loc_address"; echo isset($DataRow)?$DataRow->$var:'';?>" name="<?php echo $var;?>" class="form-control" type="text">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-2">
							...
							<div class="col-xs-6 mt7">
								...
								<div class="row">
									...
									<div class="col-xs-6 zp">
										<input class="form-control numberclass noDots" id="" name="edo_dho_visit" <?php $var ='edo_dho_visit'; echo isset($DataRow)?$DataRow->$var:''; ?> type="text">
									</div>
								</div>
								<div class="row">
									<div class="col-xs-6">
									...
									<div class="col-xs-6 zp">
										<input class="form-control numberclass noDots" id="" name="dfp_visit" value="<?php $var ='dfp_visit'; echo isset($DataRow)?$DataRow->$var:''; ?>" type="text">
									</div>
								</div>
								<div class="row">
									<div class="col-xs-6 zp">
										<input class="form-control" id="" name="other_visitor" value="<?php $var ='other_visitor'; echo isset($DataRow)?$DataRow->$var:''; ?>" type="text" placeholder="Any other person: specify">
									</div>
									<div class="col-xs-6 zp">
										<input class="form-control numberclass noDots" id="" name="other_p_visit" value="<?php $var ='other_p_visit'; echo isset($DataRow)?$DataRow->$var:''; ?>" type="text">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-xs-3 zp">
								<input class="form-control" id="" name="mod_transport" value="<?php $var ='mod_transport'; echo isset($DataRow)?$DataRow->$var:''; ?>" type="text">
							</div>
						</div>
						<div class="row">
							<div class="col-xs-12 bgcolcl text-center">
								...
								<table class="table   table-bordered">
									<tbody>
										<tr>
											...
											<td>
											<input placeholder="Problems " name="problems" value="<?php $var ='problems'; echo isset($DataRow)?$DataRow->$var:''; ?>" style="border: 0px none;width: 100%;height: 68px;" type="text">
											</td>
										</tr>
										<tr>
											...
											<td>
											<input placeholder="Recommendations"  name="recommendations" value="<?php $var ='recommendations'; echo isset($DataRow)?$DataRow->$var:''; ?>" style="border: 0px none;width: 100%;height: 68px;" type="text">
											</td>
										</tr>
									</tbody>
								</table>
