...
<html>
	<head>
		...
		<title>Malaria - Checklist for Rapid Diagnostic Test (RDT) Center || List</title>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="bgrowlis">
						<p>Malaria - Checklist for Rapid Diagnostic Test (RDT) Center</p> 
					</div>
				</div>
			</div>		
			<div class="filters">
			...
			<br>
			<?php echo getListingTable($tableData,"mcp/forms/rdt"); ?>
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>mcp/ajax_calls/rdt",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>mcp/ajax_calls/rdt/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
