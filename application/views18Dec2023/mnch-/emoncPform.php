		...
		<div class="container">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					$action = $basePath."mnch/emonc/save";
					...
					<div class="rowlightbg"> 
						...
						<div class="row">
							...
							<div class="col-xs-3">
								...
								<label class="pt7 pb2"><?php echo isset($vpvcDataRow)?$vpvcDataRow->$var.'-'.$vpvcDataRow->facility:''; ?></label>
							</div>
							<div class="col-xs-3">
								 <label>Type of Health Facility</label>
							</div>
							<div class="col-xs-3">
								<label class="pt7 pb2"><?php $var ="fatype"; echo isset($vpvcDataRow)?$vpvcDataRow->$var:''; ?></label>
							</div>
						</div>
						<div class="row">
							<div class="col-xs-3">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<label class="pt7 pb2"><?php $var ="supervisor_name"; echo isset($vpvcDataRow)?$vpvcDataRow->$var:''; ?></label>
							</div>
							<div class="col-xs-3">
								<div class="row">
									<div class="col-xs-2">
							...
							<div class="col-xs-3">
								<input value="<?php echo isset($vpvcDataRow)?get_Facility_Population($vpvcDataRow->facode):''; ?>" name="population" class="form-control numberclass noDots" type="text" >
							</div>
						</div>
						<div class="row">
							<div class="col-xs-3">
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<div class="row">
									...
									<div class="col-xs-4">
										<label>PPHI</label>&nbsp;
										<input <?php $var ='managed_by'; echo isset($DataRow)?(($DataRow->$var=="pphi")?'checked="checked"':''):''; ?> name="<?php echo $var; ?>" value="pphi" class="mt10" type="radio">
									</div>
									<div class="col-xs-4">
										<input value="<?php $var ="managed_by_text"; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" class="form-control" type="text">
									</div>
								</div>
							</div>
							<div class="col-xs-3">
							...
							<div class="row">
								...
								<div class="col-xs-9">
									<div class="row">
										...
										<div class="col-xs-3 zp bg3 mn34">
						...
						<div class="row mt5 mb5">
							...
							<div class="col-xs-2">
								<input value="<?php $var ='ca_start_date'; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
							</div>
							<div class="col-xs-1 col-xs-offset-1">
								<label class="pt7 pb2">End Date</label>
							</div>
							<div class="col-xs-2">
								<input value="<?php $var ='ca_end_date'; echo isset($DataRow)?date("d-m-Y",strtotime($DataRow->$var)):''; ?>" name="<?php echo $var; ?>" class="dp form-control anyOtherDate" type="text">
							</div>
						</div>
						<div class="row bc">
							<div class="col-xs-3">
