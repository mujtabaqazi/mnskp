				...
				<div class="panel-body pbody">
					...
					<div class="rowlightbg">
						...
						<div class="row">
							<div class="col-xs-2">
								<?php if($index==14){ ?>
								<input class="form-control" value="<?php $var ='hr_others'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" placeholder="Others" type="text">
								<?php }else if ($index==4){?>
						...
						<div class="row">
							...
							<div class="col-xs-2  zp text-center">
								<input class="form-control <?php if($index==14){ echo "numberclass";}?>" placeholder="<?php if($index==14){ echo "Specify Number:";}?>" value="<?php $var ='ir_r'.$i.'_f2'; echo isset($DataRow)?$DataRow->$var:''; ?>" name="<?php echo $var; ?>" type="text">
							</div>
						</div>
							<?php $i++;} }?>
						<div class="row" style="padding-bottom: 1px;">
						...
						<div class="row">
							...
							<div class="col-xs-2 zp">
								...
								<input class="form-control  <?php echo($i==8)?"dp text-center anyOtherDate":"numberclass noDots";?>"  value="<?php $var ='acad_r'.$i.'_f2'; if ($i==8){ echo (isset($DataRow) && $DataRow->$var !== NULL)?date("d-m-Y",strtotime($DataRow->$var)):''; }else {echo isset($DataRow)?$DataRow->$var:''; }?>" name="<?php echo $var; ?>" type="text">
								<?php }else {?>
								<div class="row">
									<div class="col-xs-6 text-right">
										<label>Yes</label>&nbsp;
