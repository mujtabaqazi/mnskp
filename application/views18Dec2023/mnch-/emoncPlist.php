...
<html>
	<head>
		...
		<title>Status Checklist for B and C EmONC Facilities || List</title>
		...
		<div class="container container-listing">
			<div class="row">
				<div class="col-md-12 text-center">
					<div class="bgrowlis">
						<p>Status Checklist for B and C EmONC Facilities</p> 
					</div>
				</div>
			</div>		
			<div class="filters">
			...
			<br>
			<?php echo getListingTable($tableData,"mnch/forms/emonc"); ?>
			<?php if(isset($paging) && $paging!=""){?>
			...
			$(document).ready(function() {
				$('#searchBtn').on('click' , function (event){
					...
					$.ajax({
						...
						url: "<?php echo base_url(); ?>mnch/ajax_calls/emonc",
						dataType: "json",
				...
				$(function(){
					$('body').on('click','ul.search_page_pagination>li>a',function(e){
						...
						$.ajax({
							url:"<?php echo base_url(); ?>mnch/ajax_calls/emonc/"+$(this).attr("data-ci-pagination-page"),
							type:'POST',
							data: $('#filter-form').serialize(),
