...
if(!function_exists('getDueSubComplianceTable')){
    function getDueSubComplianceTable($allData,$allTotal=NULL,$drilldown=false){
		$CI = & get_instance();
		$count = 0;
		$extraClass = "";
...
if(!function_exists('getSupervisorComplianceTable')){
    function getSupervisorComplianceTable($allData,$allTotal=NULL,$drilldown=false){
		$CI = & get_instance();
		$count = 0;
		$extraClass = "";
		$returnData = "<table class=\"table table-striped table-condensed table-bordered table-hover tbl-listing $extraClass\">";
...
if(!function_exists('countForDueChecklistsVisitsOf_A_Supervisor')){
	function countForDueChecklistsVisitsOf_A_Supervisor($fmonth=NULL,$supId=NULL){
		$counter = 0;
		$CI = & get_instance();
		$wc = array();
		if($fmonth)
...
if(!function_exists('countForSubChecklistsVisitsOf_A_Supervisor')){
	function countForSubChecklistsVisitsOf_A_Supervisor($fmonth=NULL,$supId=NULL){
		$counter = 0;
		$counter2 = 0;
		$CI = & get_instance();
		$wc = array();
